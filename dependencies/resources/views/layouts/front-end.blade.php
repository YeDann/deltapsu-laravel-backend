...
<body>
  ...
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/popper.min.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/bootstrap.min.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/bootstrap-select.min.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/map.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/product.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/owl.carousel.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/owl.carousel.min.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/datatables.min.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/slick.min.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/nouislider.min.js')}}"></script>

  <script type="text/javascript" async src="{{asset('/frontend-asset/js/zabuto_calendar.min.js')}}"></script>
  <script type="text/javascript" async src="{{asset('/frontend-asset/js/mb5.js')}}"></script>
