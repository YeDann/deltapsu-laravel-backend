...
<div class="invisible-nav-minimize">
  ...
  <div class="nav-position des-scrolled">
    ...
    <nav id="nav-two" class="navbar navbar-expand-lg navbar-light bg-nav">
                ...
                <ul class="dropdown-menu drp-subthree">
                  ...
                  <div class="image-dropdown d-flex justify-content-center "
                    ...
                    <img class="imageNav1 img-hove-on-dropdown lazyload"
                      data-src="{{asset('frontend-asset/image/Medical-Power-Supplies.png')}}" loading="lazy"
                      alt="Medical-Power-Supplies.png">
                  </div>
                </ul>
              </div>
              <div class="dropdown-submenu">
      ...
      {{-- Memu About Us --}}
      {{-- <li class="nav-item dropdown ">
        <a id="nav-uderline" class="nav-link " href="" id="dropdown04" data-toggle="dropdown" aria-haspopup="true"
          aria-expanded="false">{{$staticContent['About']}} <i class="zmdi zmdi-chevron-down"></i></a>
...
<ul id="distributor" class="img-pop">
  <li>
    <a href="{{route('contactSupport')}}" class="skype"><span>
        Contact Us
      </span><i class="demo-icon icon-facon icon-find-dis-blue"></i></a>
  </li>
</ul>
      ...
      <form id="submitGuiDownload" onsubmit="return validateFormGUI(this)" action="{{route('downloadGui')}}"
        ...
        <div class="modal-body px-4 mb-4">
          ...
          <div class="input-label w-100 my-4">
            ...
            <input type="text" class="form-control" name="name_gui" pattern="[A-Za-zก-๏\s]+" placeholder="Name"
              required>
          </div>
          <div class="input-label w-100 my-4">
          ...
          <div class="box-input-checkbox">
            <input class="inp-cbx" name="data_conf" id="cxguiup" value="1" type="checkbox" style="display: none;" />
