...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <br>
        <form id="form-work" class="form-horizontal" role="form" autocomplete="off" action="{{route('successCaseUpdate')}}"
            method="post" novalidate="novalidate" enctype="multipart/form-data">
            {{csrf_field()}}
            <input type="hidden" name="successCaseId" value="{{$contents[0]->content_id}}">
