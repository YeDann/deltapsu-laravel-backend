    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="{{route('createContinent' ,$type_id)}}" class="btn btn-success">Create</a>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="text-center">
                            <a href="{{route('getOffices' ,[$item->id ,$type_id])}}" class="btn btn-outline-info">
                                @if($type_id == 1)
                                Sales Offices
                                @else 
                                Distributors
                            ...
                            <a href="{{route('editContinent' ,[$item->id ,$type_id])}}" class="btn btn-primary">Edit</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="{{route('deleteContinent')}}" method="POST" >
                        {{csrf_field()}}
