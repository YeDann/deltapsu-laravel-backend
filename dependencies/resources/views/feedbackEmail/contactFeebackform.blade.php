        ...
        <div class="block-header block-header-default">
            <div class="Absolute-Center">
                <select onchange="getFiler()" class="js-select2 form-control" id="pro_categories" name="categories_doc"
                    ...
                    <option value="Sale Enquiries" {{isset($selecValue) && $selecValue=='Sale Enquiries' ? 'selected'
                        :'' }}>Sale Enquiries</option>
                    <option value="Products and Service Support" {{isset($selecValue) &&
                        $selecValue=='Products and Service Support' ? 'selected' :'' }}>Products and Service Support
                    </option>
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="{{route('exportfeedbackFrom',$selecValue)}}" class="btn btn-outline-primary">Export
                        Data</a>
                </div>
            </div>
        </div>
