...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <br>
        <form id="form-work" class="form-horizontal" role="form" autocomplete="off" action="{{route('productNoticeUpdate')}}"
            method="post" novalidate="novalidate" enctype="multipart/form-data">
            {{csrf_field()}}
            <input type="hidden" name="productNoticeId" value="{{$contents[0]->content_id}}">
                          ...
                          ?>
                            ...
                            <div class="tab-pane {{($loop->iteration == 1)?" active":""}}"
                                ...
                                <div class="form-group w-50">
                                    ...
                                    <a href="{{route('removeFileProductNoticeDoc',[$item->name, $contents[0]->content_id])}}"
