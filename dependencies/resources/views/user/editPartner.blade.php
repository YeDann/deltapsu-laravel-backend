    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <a href="{{route('backendUser.index')}}" >Partner</a></li>
...
<div class="content mb-5">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content mb-5">
            <form id="submitformbkuser" method="POST" action="{{ route('updatepartner') }}">
                @csrf
                <!-- Basic Elements -->
                    ...
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-1" name="role" value="1"  {{$user->role == 1 ?'checked':'' }} >
                                    <label class="custom-control-label" for="status-1">Distributor</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-2" name="role" value="2"  {{$user->role == 2 ?'checked':'' }} >
