    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="{{route('partner.create')}}" class="btn btn-success"> Create </a>
                    <a href="{{route('ExportPartner')}}" class="btn btn-primary"> Export Data </a>
        ...
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="d-none d-sm-table-cell">{{$item->firstname.' '.$item->lastname }}</td>
                    ...
                    <td class="text-center">
                        <a href="{{route('partner.edit',$item->id)}}" class="btn btn-primary">Edit </a>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <form action="{{route('destroyUserPartner')}}" method="POST" >
                    {{csrf_field()}}
