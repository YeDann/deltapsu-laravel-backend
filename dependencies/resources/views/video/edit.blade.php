...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <br>
        <form id="form-work" class="form-horizontal" role="form" autocomplete="off" action="{{route('videoUpdate')}}"
            method="post" novalidate="novalidate" enctype="multipart/form-data">
            {{csrf_field()}}
            <input type="hidden" name="videoId" value="{{$contents[0]->content_id}}">
            <input type="hidden" name="oldMainFile" value="{{$contents[0]->file}}">
            <input type="hidden" name="oldThumb" value="{{$contents[0]->thumb}}">
            <div class="row pl-4 pr-4">
                          ...
                          ?>
                            ...
                            <div class="tab-pane {{($loop->iteration == 1)?" active":""}}"
                                ...
                                <div class="form-group w-50">
                                    ...
                                    <a href="{{route('removeFileVideoDoc', [$item->name, $contents[0]->content_id])}}"
                                ...
                                <div class="form-group">
                                    ...
                                    <div id="item-wrap">
                                        <input id="input-metaTitle-{{$item->name}}"
                                            data-fn-keyup="countCharacter" data-fn-args='[{{ json_encode('metaTitle-'.$item->name) }}]' type="text" class="form-control"
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <select name="videoType" class="form-control" id="">
                    ...
                    <div class="form-group">
                        <label for="video-link-input">Video Link (YouTube URL)*</label>
                        <input type="url" class="form-control" name="video_link" 
                               value="{{isset($contents[0]->video_link) ? $contents[0]->video_link : ''}}" 
                    ...
                    <div class="form-group text-center">
                        ...
                        <a href="{{route('video.index')}}" class="btn btn-secondary text-uppercase col-2">Cancel
                        </a>
                    </div>
                </div>
            </div>
