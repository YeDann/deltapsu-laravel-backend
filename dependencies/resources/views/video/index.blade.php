    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">
                ...
                <a href="{{route('video-type.index')}}" class="btn btn-info">Video Type</a>
            </h3>
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="{{route('video.create')}}" class="btn btn-success"><i class="fa fa-plus"></i> Create </a>
                    {{-- <a href="{{route('ImportNewsData','video')}}" class="btn btn-info" > GET Data </a> --}}
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "{{ (route('destroyVideo')) }}/" + id;
                });
            }
        });
    }
