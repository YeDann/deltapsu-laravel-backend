    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Industry Know-How</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">
                {{-- <form action="{{route('deleteIndustryKnowHow')}}" method="post">
                    {{csrf_field()}}
                    <button type="submit" class="btn btn-danger">Delete {{$countContent}} </button>
                </form> --}}
                <a href="{{route('industry-know-how-type.index')}}" class="btn btn-info">Industry Know-How Type</a>
            </h3>
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="{{route('industry-know-how.create')}}" class="btn btn-success"><i class="fa fa-plus"></i> Create </a>
                    {{-- <a href="{{route('ImportNewsData','industry-know-how')}}" class="btn btn-info" > GET Data </a> --}}
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "{{ (route('destroyIndustryKnowHow')) }}/" + id;
                });
            }
        });
    }
