    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Industry Know-How Type</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title"><a href="{{route('industry-know-how.index')}}" class="btn btn-info" > <i class="fa fa-chevron-left"></i>  Industry Know-How</a></h3>
            <div class="block-options">
                <div class="block-options-item">
                    <a href="{{route('industry-know-how-type.create')}}" class="btn btn-success">Create </a>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <div class="">
                                <a href="{{route('industry-know-how-type.edit',$item->id)}}" class="btn btn-primary">Edit </a>
                            <button type="button" class="btn btn-danger" data-toggle="tooltip" id="delbutton"
                                title="Delete" data-fn-click="deleteIndustryKnowHowType" data-fn-args='[{{$item->id}}]'>
                                Delete
                            </button>
                        </div>
                    </td>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "{{ (route('industryKnowHowTypeDestroy')) }}/" + id;
                });
            }
        });
    }
