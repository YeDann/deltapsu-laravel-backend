...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title"><a href="{{route('newstype.index')}}" class="btn btn-info" > <i class="fa fa-chevron-left"></i>  News Type</a></h3>
        </div>
        <div class="block-content">
            <form action="{{route('technicaltypeUpdate')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <!-- Basic Elements -->
                <input type="hidden" name="techId" value="{{$contents[0]->tech_id}}" > 
                <div class="row push">
                    <div class="col-lg-4">
                        <p class="text-muted">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{route('technical.index')}}"  class="btn btn-secondary ">
                                Cancel 
                            </a>
                        </div>
                    </div>
