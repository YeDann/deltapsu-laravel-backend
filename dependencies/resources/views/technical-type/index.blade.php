...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title"><a href="{{route('technical.index')}}" class="btn btn-info" >  Technical</a></h3>
            <div class="block-options">
                <div class="block-options-item">
                    <a href="{{route('technical-type.create')}}" class="btn btn-success">Create <i class="fa fa-plus"></i></a>
                </div>
            </div>
        </div>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <div class="">
                                <a href="{{route('technical-type.edit',$item->tech_id)}}" class="btn btn-primary">Edit  </a>
                            <button type="button" class="btn  btn-danger" data-toggle="tooltip" id="delbutton"
                                title="Delete" data-fn-click="deleteIndex" data-fn-args='[{{$item->tech_id}}]'>
                                Delete 
                            </button>
                        </div>
                    </td>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "{{ (route('technicaltypeDestroy')) }}/" + id;
                });
            }
        });
    }
