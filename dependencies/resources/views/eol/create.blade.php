                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-8">
                        ...
                        <div class="form-group w-50">
                            ...
                            <select name="eolType" class="form-control" id="" required>
                        ...
                        <div class="form-group w-50">
                            ...
                            <div class="custom-file">
                                <input type="file" class="custom-file-input" name="file[eolfile]"
                                    data-toggle="custom-file-input" id="file_input">
                                <label class="custom-file-label" for="file_input">Choose file</label>
                                <input type="hidden" name="namefile[eolfile]" value="eolfile">
                            </div>
                        </div>
                        <hr>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <a href="{{route('eol.index')}}" class="btn btn-secondary col-md-2">
                                Cancel
                            </a>
                        </div>
