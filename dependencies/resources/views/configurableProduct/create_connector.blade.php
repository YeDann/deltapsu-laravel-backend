        ...
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"> <a href="{{route('connector_image',$productId)}}">Connector Image(s)</a></li>
...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            <form action="{{route('storeConnectorImage')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <!-- Basic Elements -->
                <div class="row">
                    <div class="col-lg-12">
                           ...
                           <div class="form-group">
                            ...
                            <input type="text"
                                ...
                                name="connect_code" placeholder="Enter Connector Code..." required>
                          </div>
