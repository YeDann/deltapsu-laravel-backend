                    ...
                    <div class="col-md-12">
                            ...
                            <div class="block block-rounded block-bordered">
                                    ...
                                    <div class="tab-pane {{($loop->iteration == 1)?'active':''}}" id="btabs-alt-static-{{$item2->name}}" role="tabpanel">
                                            ...
                                            name="productCode[{{$item2->name}}]" value="{{ isset($current->product_code)? $current->product_code :''}}" placeholder="Enter name..." >
                                            </div>
                                         
                                                <div class="form-group">
                                                        <label for="">Content</label>
                                                        <textarea name="content[{{$item2->name}}]" class="jsnotenew">{{ isset($current->description)? $current->description :''}}</textarea>
                                                    </div>
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-group">
                                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                    <input type="radio" class="custom-control-input" id="status-1" name="max_slot" value="1" required {{($cproducts[0]->max_slot == 1) ? 'checked':''}}>
                                                    <label class="custom-control-label" for="status-1">1</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                    <input type="radio" class="custom-control-input" id="status-2" name="max_slot" value="2" required {{($cproducts[0]->max_slot == 2) ? 'checked':''}}>
                                                    <label class="custom-control-label" for="status-2">2</label>
                                                </div>
                                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                        <input type="radio" class="custom-control-input" id="status-3" name="max_slot" value="3" required {{($cproducts[0]->max_slot == 3) ? 'checked':''}}>
                                                        <label class="custom-control-label" for="status-3">3</label>
                                                    </div>
                                                    <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                            <input type="radio" class="custom-control-input" id="status-4" name="max_slot" value="4"  required {{($cproducts[0]->max_slot == 4) ? 'checked':''}}>
                                                            <label class="custom-control-label" for="status-4">4</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                <input type="radio" class="custom-control-input" id="status-5" name="max_slot" value="5" required {{($cproducts[0]->max_slot == 5) ? 'checked':''}}>
                                                                <label class="custom-control-label" for="status-5">5</label>
                                                            </div>
                                                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                    <input type="radio" class="custom-control-input" id="status-6" name="max_slot" value="6" required {{($cproducts[0]->max_slot == 6) ? 'checked':''}}>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                 <input type="radio" class="custom-control-input" id="status_1" name="status" value="1" {{($cproducts[0]->status == 1) ? 'checked':''}}>
                                             <label class="custom-control-label" for="status_1">Show</label>
                                                </div>
                                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                              <input type="radio" class="custom-control-input" id="status_2" name="status" value="0" {{($cproducts[0]->status == 2) ? 'checked':''}}>
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                ...
                                                <img src="{{config('app.url')}}/media/model/{{$cproducts[0]->thumb_img}}"
                                                    ...
                                                    <input type="hidden" name="oldfile[thumbnail]" value="{{$cproducts[0]->thumb_img}}" >
                                            </td>
                                            <td class="font-w600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <img src="{{config('app.url')}}/media/model/{{$cproducts[0]->certificate_img}}"
                                                    class="img-thumbnail res-image" alt="">
                                                    <input type="hidden" name="oldfile[certificate]" value="{{$cproducts[0]->certificate_img}}" >
                                            </td>
                                            <td class="font-w600">
                                        ...
                                        <tr>
                                            ...
                                            <td class="">
                                                <img src="{{config('app.url')}}/media/model/{{$cproducts[0]->preview_img}}"
                                                    class="img-thumbnail res-image" alt="">
                                                    <input type="hidden" name="oldfile[preview]" value="{{$cproducts[0]->preview_img}}" >
                                            </td>
                                            <td class="font-w600">
