            ...
            <table class="table table-bordered table-striped table-vcenter">
                <thead>
                    <tr>
                        ...
                        {{-- <th class="d-none d-sm-table-cell" style="width: 10%;">Condition</th> --}}
            ...
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <div class="col-lg-12 p-4">
                        <form id="f_data_slot" action="{{route('storeParallel')}}" method="POST" >
                            {{csrf_field()}}
                            <input type="hidden" name="itemId_edit" id="itemId_edit">
                            <input type="hidden"  name="max_slot" value="{{$cproducts->max_slot}}"  >
                            <input type="hidden"  name="model_id" value="{{$cproducts->id}}"  >
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="{{route('deleteParalle')}}" method="POST" >
                        {{csrf_field()}}
                        <input type="hidden" 
                        name="model_id" value="{{$cproducts->id}}"  >
