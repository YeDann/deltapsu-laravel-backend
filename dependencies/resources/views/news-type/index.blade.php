...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title"><a href="{{route('news.index')}}" class="btn btn-info" > <i class="fa fa-chevron-left"></i>  News</a></h3>
            <div class="block-options">
                <div class="block-options-item">
                    <a href="{{route('newstype.create')}}" class="btn btn-success">Create </a>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "{{ (route('newstypeDestroy')) }}/" + id;
                });
            }
        });
    }
