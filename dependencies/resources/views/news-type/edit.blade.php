...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title"><a href="{{route('newstype.index')}}" class="btn btn-info" > <i class="fa fa-chevron-left"></i> Product News Type</a></h3>
        </div>
        <div class="block-content">
            <form action="{{route('newstypeUpdate')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <!-- Basic Elements -->
