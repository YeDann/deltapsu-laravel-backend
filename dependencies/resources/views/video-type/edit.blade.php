    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">Video Type</li>
...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title"><a href="{{route('video-type.index')}}" class="btn btn-info" > <i class="fa fa-chevron-left"></i> Video Type</a></h3>
        </div>
        <div class="block-content">
            <form action="{{route('videoTypeUpdate')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <!-- Basic Elements -->
                        ...
                        <div class="block block-rounded block-bordered">
                            ...
                            <div class="block-content tab-content">
                                ...
                                <div class="form-group">
                                    ...
                                    <a href="{{route('video-type.index')}}"  class="btn btn-secondary">
                                        Cancel
                                    </a>
                                </div>
                            </div>
