    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="{{route('createOffices',[$conid,$type_id])}}" class="btn btn-success">Create</a>
                </div>
            </div>
        </div>
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="d-none d-sm-table-cell">{{$item->sub_title}}</td>
                    <td class="text-center">
                            <a href="{{route('editOffices',[$item->id ,$conid,$type_id])}}" class="btn btn-primary">Edit</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="{{route('deleteOffices')}}" method="POST" >
                        {{csrf_field()}}
