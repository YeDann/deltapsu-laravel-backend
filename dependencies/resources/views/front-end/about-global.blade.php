...
<div class="box-deltapsu">
    <div class="container">
        ...
        <div class="visible-up-922">
            <div class="row">
                    ...
                    <div class="text-center mb30">   
                        <div class="wrp-map">          
                        <img src="{{asset('/frontend-asset/image/global-map/Map.svg')}}" class="img-responsive img-first">          
                        <img src="{{asset('/frontend-asset/image/global-map/M-America.svg')}}" class="m-americas" style="display: none; opacity: 1;">          
                        <img src="{{asset('/frontend-asset/image/global-map/M-Asia.svg')}}" class="m-asia">          
                        <img src="{{asset('/frontend-asset/image/global-map/M-Europe.svg')}}" class="m-europe">          
                        <img src="{{asset('/frontend-asset/image/global-map/Clear.png')}}"class="img-responsive img-line" usemap="#area-world" height="592" width="1140" style=" height: auto;">          
        ...
        <div class="invisible-up-922 mb-5 mt-4">
            <a class="btn btn-subscribe w-100 mb-3" href="http://www.delta-americas.com/">{{$staticContent['America']}}</a>
            <a class="btn btn-subscribe w-100 mb-3" href="http://www.deltaww.com/default.aspx?hl=zh-TW">{{$staticContent['Asia']}}</a>
            <a class="btn btn-subscribe w-100 mb-3" href="http://www.delta-emea.com/default.aspx?hl=en-GB">{{$staticContent['Europe']}}</a>
        </div>
