        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#">{{$staticContent['catalogs']}}</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<script>
      ...
      function searchmarketingbycate(){
        ...
        $.each(resultsearch, function(index,value){
            ...
            html += '</div>';
            html += '<a href="{{config('app.url')}}/medias/marketing_resources/'+value['file']+'"  download="" >';
