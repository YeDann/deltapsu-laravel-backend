        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#"> {{$staticContent['Product_launch_Schedule']}}</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="box-events mb-5">
    <div class="container">
        <h2 class="text-title-delta visible-up-922">{{$staticContent['Product_launch_Schedule']}}</h2>
                ...
                <table id="" class="table " cellspacing="5em" width="100%">
                    ...
                    <tbody id="dataproLaunch_des">
                        ...
                        {{-- <tr class="box-cardlist row_table" style="">
                            <td class="text-middle-td"><h5 class="text-color-delta  m-0">MEB-500A24F AA</h5></td>
                            ...
                            <td class="text-middle-td"><div class="btn btn-ft w-100"> DOWNLOAD</div></td>
                        </tr> --}}
                    </tbody>
                </table>
            </div>
    ...
    function loadproductLaunch(date){
        ...
        $.each(pro_launch_schedules, function(index,pro_launch){
         if(checkDateDate(pro_launch['monthdate'] ,date)){
            ...
            html += '<td class="text-middle-td"> <a href="{{config('app.url')}}/medias/marketing_resources/'+pro_launch['file']+'" download > <div class="btn btn-ft w-100"> {{$staticContent['Downloads']}}</div></td>';
            html += '</tr>';
            ...
            mobilehtml += '</div>';
            mobilehtml +=  '<a href="{{config('app.url')}}/medias/marketing_resources/'+pro_launch['file']+'" download >';
