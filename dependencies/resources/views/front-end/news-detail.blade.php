        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb-home" aria-current="page"><a href="{{route('index','news')}}">{{$staticContent['Product_News']}}</a></li>
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#">{{isset($contents[0]->title)? $contents[0]->title:'' }}</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<section class="box-news  my-5 {{-- visible-up-922 --}}">
    <div class="container">
        <div class="box-news-detail">
            ...
            <hr size="2">
            <div class="post-meta">
            <span class="sub-news new" style="color:{{isset($contents[0]->color_type)? $contents[0]->color_type:'' }}">
    ...
    <div class="container">
        ...
        <div class="content">
            <div class="img-content">
                <img src="{{asset('/frontend-asset/image/adult-data-database-1181316@2x.png')}}" alt="" class="img-fluid w-100">
            </div>
            <p class="my-4">Beijing, China, October 17-19, 2018 – Delta joined China Wind Power 2018 (CWP 2018), one of China’s most influential trade events in the wind industry.</p>    
            <p class="mb-4">At CWP 2018, Delta showcased its industrial power supplies suitable for wind turbine systems. The highlighted products included the CliQ M series of DIN Rail Power Supply which Delta presented alongside its industrial automation products as a total system solution for wind turbines. In addition, Delta displayed its wide range of industrial power supplies for other applications that include its panel mount power supplies and LED drivers.            </p>
            <p class="mb-4">To find out about our next event, please visit. http://www.deltapsu.com/events</p>    
            <div class="img-content my-4">
                
                    <img src="{{asset('/frontend-asset/image/jason-blackeye-nyL-rzwP-Mk-unsplash@2x.png')}}" alt="" class="img-fluid w-100">
                </div>
            <div class="img-content mb-4">
                ...
                <p class="mb-4">Beijing, China, October 17-19, 2018 – Delta joined China Wind Power 2018 (CWP 2018), one of China’s most influential trade events in the wind industry.</p>
                <p class="mb-4">At CWP 2018, Delta showcased its industrial power supplies suitable for wind turbine systems. The highlighted products included the CliQ M series of DIN Rail Power Supply which Delta presented alongside its industrial automation products as a total system solution for wind turbines. In addition, Delta displayed its wide range of industrial power supplies for other applications that include its panel mount power supplies and LED drivers.</p>
                <p class="mb-4">To find out about our next event, please visit. http://www.deltapsu.com/events</p>
                <p class="mb-4">Etiam convallis elementum sapien, a aliquam turpis aliquam vitae. Praesent sollicitudin felis vel mi facilisis posuere. Nulla ultrices facilisis justo, non varius nisl semper vel. Interdum et malesuada fames ac ante ipsum primis in faucibus. Phasellus at ante mattis, condimentum velit et, dignissim nunc. Integer quis tincidunt purus. Duis dignissim mauris vel elit commodo, eu hendrerit leo ultrices.</p>
                <p class="mb-4">Nulla vehicula vestibulum purus at rutrum. Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Curabitur dignissim massa nec libero scelerisque rutrum. Curabitur ac purus id elit hendrerit lacinia. Nullam sit amet sem efficitur, porta diam in, convallis tortor.</p>
        </div>
