...
<div class="uk-width-1-2@s"><label class="uk-form-label" style="color:#fff;"><span data-i18n="contact.country">COUNTRY</span><span style="color:#ff4444;margin-left:3px;">*</span> </label> <input class="uk-input input-neon" id="cf-country" type="text" /> <span class="cf-error" id="cf-country-err"></span></div>
...
<div class="uk-width-1-1"><label class="uk-form-label" data-i18n="contact.projectStatusLabel" style="color:#fff;">Do you have an active or upcoming project that requires a power supply solution?</label><select class="uk-select input-neon" id="cf-project-status" style="background:#0a1628;color:#fff;border-color:rgba(0,242,255,0.3);"><option value="" data-i18n-option="contact.projectStatusPlaceholder">-- Select --</option><option value="a" data-i18n-option="contact.projectStatusOpt1">Yes, currently in development</option><option value="b" data-i18n-option="contact.projectStatusOpt2">Yes, planning within the next 6 months</option><option value="c" data-i18n-option="contact.projectStatusOpt3">Researching for future projects</option><option value="d" data-i18n-option="contact.projectStatusOpt4">No specific project at the moment</option></select></div>
...
(function() {
  ...
  var translations = {
    ...
    'zh-TW': {
      ...
      'contact.formTitle':'申請諮詢','contact.company':'公司名稱','contact.name':'姓名','contact.email':'電子郵件','contact.country':'國家／地區','contact.phone':'電話','contact.product':'產品','contact.productPlaceholder':'-- 請選擇 --','contact.projectStatusLabel':'您目前是否有正在進行或即將啟動、且需要電源供應解決方案的專案？','contact.projectStatusPlaceholder':'-- 請選擇 --','contact.projectStatusOpt1':'是，目前正在開發中','contact.projectStatusOpt2':'是，計畫在未來 6 個月內啟動','contact.projectStatusOpt3':'正在為未來的專案進行研究','contact.projectStatusOpt4':'目前沒有具體的專案','contact.message':'訊息內容','contact.send':'送出申請','contact.privacyAgree':'我已閱讀並同意<a href="https://psu.deltaww.com/tw/etc/privacy-policy" target="_blank" style="color:#05a3f7;">隱私權政策</a>。','contact.privacyRequired':'請勾選同意隱私權政策。','contact.disclaimer':'',
    ...
    'zh-CN': {
      ...
      'contact.formTitle':'申请咨询','contact.company':'公司名称','contact.name':'姓名','contact.email':'电子邮件','contact.country':'国家/地区','contact.phone':'电话','contact.product':'产品','contact.productPlaceholder':'-- 请选择 --','contact.projectStatusLabel':'您目前是否有正在进行或即将启动、且需要电源解决方案的项目？','contact.projectStatusPlaceholder':'-- 请选择 --','contact.projectStatusOpt1':'是，目前正在开发中','contact.projectStatusOpt2':'是，计划在未来 6 个月内启动','contact.projectStatusOpt3':'正在为未来的项目进行研究','contact.projectStatusOpt4':'目前没有具体的项目','contact.message':'留言内容','contact.send':'提交申请','contact.privacyAgree':'我已阅读并同意<a href="https://www.deltapsu.cn/cn/etc/privacy-policy" target="_blank" style="color:#05a3f7;">隐私政策</a>。','contact.privacyRequired':'请勾选同意隐私政策。','contact.disclaimer':'',
    ...
    'ja': {
      ...
      'contact.formTitle':'お問合せ','contact.company':'会社名','contact.name':'氏名','contact.email':'メールアドレス','contact.country':'国・地域','contact.phone':'電話番号','contact.product':'製品','contact.productPlaceholder':'-- 選択してください --','contact.projectStatusLabel':'現在、電源ソリューションを必要とする進行中または予定されているプロジェクトはありますか？','contact.projectStatusPlaceholder':'-- 選択してください --','contact.projectStatusOpt1':'はい（現在開発中）','contact.projectStatusOpt2':'はい（今後6ヶ月以内に計画中）','contact.projectStatusOpt3':'将来のプロジェクトに向けて調査中','contact.projectStatusOpt4':'現時点では具体的なプロジェクトはない','contact.message':'メッセージ','contact.send':'送信する','contact.privacyAgree':'<a href="https://psu.deltaww.com/jp/etc/privacy-policy" target="_blank" style="color:#05a3f7;">プライバシーポリシー</a>を読み、同意しました。','contact.privacyRequired':'プライバシーポリシーに同意してください。','contact.disclaimer':'',
