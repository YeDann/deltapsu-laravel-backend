...
(function() {
  ...
  var translations = {
    ...
    'zh-TW': {
      ...
      'contact.formTitle':'申請諮詢','contact.company':'公司名稱','contact.name':'姓名','contact.email':'電子郵件','contact.country':'國家／地區','contact.phone':'電話','contact.product':'產品','contact.productPlaceholder':'-- 請選擇 --','contact.message':'訊息內容','contact.send':'送出申請','contact.privacyAgree':'我已閱讀並同意<a href="https://psu.deltaww.com/tw/etc/privacy-policy" target="_blank" style="color:#05a3f7;">隱私權政策</a>。','contact.privacyRequired':'請勾選同意隱私權政策。','contact.disclaimer':'',
    ...
    'zh-CN': {
      ...
      'contact.formTitle':'申请咨询','contact.company':'公司名称','contact.name':'姓名','contact.email':'电子邮件','contact.country':'国家/地区','contact.phone':'电话','contact.product':'产品','contact.productPlaceholder':'-- 请选择 --','contact.message':'留言内容','contact.send':'提交申请','contact.privacyAgree':'我已阅读并同意<a href="https://www.deltapsu.cn/cn/etc/privacy-policy" target="_blank" style="color:#05a3f7;">隐私政策</a>。','contact.privacyRequired':'请勾选同意隐私政策。','contact.disclaimer':'',
    ...
    'ja': {
      ...
      'contact.formTitle':'お問合せ','contact.company':'会社名','contact.name':'氏名','contact.email':'メールアドレス','contact.country':'国・地域','contact.phone':'電話番号','contact.product':'製品','contact.productPlaceholder':'-- 選択してください --','contact.message':'メッセージ','contact.send':'送信する','contact.privacyAgree':'<a href="https://psu.deltaww.com/jp/etc/privacy-policy" target="_blank" style="color:#05a3f7;">プライバシーポリシー</a>を読み、同意しました。','contact.privacyRequired':'プライバシーポリシーに同意してください。','contact.disclaimer':'',
