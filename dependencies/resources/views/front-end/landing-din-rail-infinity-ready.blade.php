...
(function initMiniPlayer() {
  ...
  var _ytId = (window._locale === 'tw' || window._locale === 'jp') ? 'a7yNo8fZzFY' : 'FwiK4JtE1QM';
...
<div class="video-frame" id="overview-video-frame" style="cursor:default;"><iframe allow="autoplay; encrypted-media" allowfullscreen="" id="overview-yt-iframe" src="{{ App::getLocale() === 'cn' ? 'https://player.bilibili.com/player.html?bvid=BV1R6Lz6GEsB' : 'https://www.youtube.com/embed/'.(in_array(App::getLocale(), ['tw', 'jp']) ? 'a7yNo8fZzFY' : 'FwiK4JtE1QM').'?autoplay=1&mute=1&rel=0&modestbranding=1&enablejsapi=1' }}" style="position:absolute;top:0;left:0;width:100%;height:100%;border:none;display:block;"></iframe>
...
(function() {
  ...
  window.openYoutubeModal = function(e) {
    if (e) { e.preventDefault(); e.stopPropagation(); }
    var _ytId = (window._locale === 'tw' || window._locale === 'jp') ? 'a7yNo8fZzFY' : 'FwiK4JtE1QM';
    document.getElementById('yt-iframe').src = window._locale === 'cn' ? 'https://player.bilibili.com/player.html?bvid=BV1R6Lz6GEsB' : 'https://www.youtube.com/embed/' + _ytId + '?autoplay=1&rel=0&modestbranding=1';
  ...
  window.switchLang = function(lang, el) {
    ...
    if (overviewIframe) overviewIframe.src = window._locale === 'cn' ? 'https://player.bilibili.com/player.html?bvid=BV1R6Lz6GEsB' : 'https://www.youtube.com/embed/' + _ytId + '?autoplay=1&mute=1&rel=0&modestbranding=1&enablejsapi=1';
