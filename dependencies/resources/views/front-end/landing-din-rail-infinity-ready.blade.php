...
<div data-i18n="hero.upcomingLabel" style="font-size:clamp(0.7rem,1.2vw,0.95rem);color:rgba(255,255,255,0.7);">Delta&#39;s Upcoming New Products at a Glance</div>

<div style="display:flex;flex-direction:column;align-items:center;gap:8px;justify-content:center;"><span data-i18n="hero.dinRailLabel" style="color:#00f2ff;font-weight:700;font-size:clamp(0.85rem,1.5vw,1.1rem);">DIN Rail Power Supplies</span>

<div style="display:flex;flex-direction:row;align-items:center;gap:12px;flex-wrap:nowrap;justify-content:center;"><a href="#din-pro" onmouseout="this.style.background='rgba(5,163,247,0.1)';this.style.borderColor='rgba(5,163,247,0.55)'" onmouseover="this.style.background='rgba(5,163,247,0.22)';this.style.borderColor='#05a3f7'" style="display:inline-flex;align-items:center;justify-content:center;gap:4px;padding:7px 16px;border-radius:50px;border:1.5px solid rgba(5,163,247,0.55);background:rgba(5,163,247,0.1);color:#fff !important;font-weight:700;font-size:0.78rem;letter-spacing:1px;text-decoration:none;transition:all 0.2s;backdrop-filter:blur(8px);white-space:nowrap;"><span data-i18n="nav.dinpro" style="color:#fff !important;">DIN Pro</span> <svg fill="none" height="11" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" viewbox="0 0 24 24" width="11"><polyline points="9 18 15 12 9 6"></polyline></svg></a> <a href="#din-eco" onmouseout="this.style.background='rgba(0,241,205,0.08)';this.style.borderColor='rgba(0,241,205,0.55)'" onmouseover="this.style.background='rgba(0,241,205,0.2)';this.style.borderColor='#00f1cd'" style="display:inline-flex;align-items:center;justify-content:center;gap:4px;padding:7px 16px;border-radius:50px;border:1.5px solid rgba(0,241,205,0.55);background:rgba(0,241,205,0.08);color:#fff !important;font-weight:700;font-size:0.78rem;letter-spacing:1px;text-decoration:none;transition:all 0.2s;backdrop-filter:blur(8px);white-space:nowrap;"><span data-i18n="nav.dineco" style="color:#fff !important;">DIN Eco</span> <svg fill="none" height="11" stroke="#fff" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" viewbox="0 0 24 24" width="11"><polyline points="9 18 15 12 9 6"></polyline></svg></a></div>
</div>
</div>
</div>
<script>
...
<div style="width:100%;"><img src="{{ asset('images/landing/din-pro-and-din-eco.png') }}" alt="din-pro-and-din-eco" style="width:100%;" /></div>
...
<div class="uk-margin"><label class="notify-checkbox"><input id="py-agree" type="checkbox" /> <span data-i18n="notify.privacyAgree">By submitting this form, You understand and agree to our privacy policy.</span></label> <span class="cf-error" id="py-agree-err"></span></div>
