 ...
 <div class="bg-bredcrumb">
  <div class="container">
   <nav aria-label="breadcrumb" id="breadcrumb">
    <ol class="breadcrumb">
     <li class="breadcrumb-item text-breadcrumb-home"><a href="{{route('index','home')}}">{{$staticContent['Home']}}</a>
     </li>
     {{-- <li class="breadcrumb-item active text-breadcrumb-home dropdown" aria-current="page"><a href="#"
       data-toggle="dropdown" id="tools-dropdown">DOWNLOADS</a>
    ...
    <div class="center">
     ...
     <div id="requestpassword" class="col-sm-6 w-100 mx-auto mb-3">
      ...
      <input type="password" class="input-login" name="password" id="inputPassword" pattern="{8,}"
       title="Must at least 8 or more characters" placeholder="{{$staticContent['Password']}}" required>
     </div>
   ...
   <div class="modal-body px-4 mb-4">
    <form action="{{route('checkpartnerAccount')}}" method="POST">
     ...
     <div class="input-label w-100 my-4">
      <h6 class="mb-0"><label class="text-dark">{{$staticContent['Email_Address']}}<span class="red">*</span></label>
      </h6>
