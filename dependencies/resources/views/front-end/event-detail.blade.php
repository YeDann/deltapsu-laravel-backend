...
@section('meta')
<?php 
  $e_title = trim(iconv_substr(strip_tags(isset($contents[0]->title)? $contents[0]->title:''),0,32,'UTF-8')) ;
  $s_event = isset($staticContent['Events&Calendar']) ? $staticContent['Events&Calendar'] :'';
  $meta_title = $e_title.' | '.$s_event.' | '.'DeltaPSU';
?>
            ...
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb-home" aria-current="page"><a
                            href="{{route('index','events')}}">{{$staticContent['Events&Calendar']}}</a></li>
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a
                            href="#">{{$staticContent['Event']}} {{$staticContent['Details']}}</a></li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="box-news-detail">
            ...
            <div class="content row">
                <div class="col-lg-6 image-event  order-lg-1">
                    <img class="w-100"
                        src="{{config('app.url')}}/uploads_delta/{{isset($contents[0]->thumb)?$contents[0]->thumb:'' }}"
                        alt="">
                    {{-- <div class="gmap_canvas">
                        <iframe
                            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3242.2171281810674!2d140.03250051555025!3d35.64702173945416!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6022821fd52ebfdf%3a0xcec0c09c4bed45e0!2smakuhari%20messe%20event%20hall!5e0!3m2!1sen!2sth!4v1573466921112!5m2!1sen!2sth"
                ...
                <div class="col-lg-6 text-event mt-2 order-1 order-lg-2">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h5 class="mt-0 text-sixteen-delta">{{$contents[0]->time_start}} –
                                {{$contents[0]->time_end}}</h5>
                        </div>
                    </div>
                    ...
                    {{-- <p class="mb-4">TECHNO-FRONTIER is an ideal place where visitors can get information about the
                        latest technologies & products in Electronics and Mechatronics gather here. Each clearly-focused
                        exhibition enables the professionals to locate what they need, and the wide range of the
                        products sparks ideas on possibilities of technical coordination.</p>
    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="my-3">
                ...
                <p class="mb-4">TECHNO-FRONTIER is an ideal place where visitors can get information about the latest
                    technologies & products in Electronics and Mechatronics gather here. Each clearly-focused exhibition
                    enables the professionals to locate what they need, and the wide range of the products sparks ideas
                    on possibilities of technical coordination.</p>
                <p class="mb-4">Booth Number : 5C-18</p>
                <p class="mb-4">Website: http://www.jma.or.jp/tf/en</p>
            </div>
            <div class="gmap_canvas">
