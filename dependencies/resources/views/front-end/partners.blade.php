        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#">{{$staticContent['Partners']}}</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<section class="box-news pb-5">
    <h2 class="text-title-delta visible-tablets-up">{{$staticContent['Partners']}}</h2>
