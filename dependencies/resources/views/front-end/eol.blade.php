        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb-home dropdown" aria-current="page">
                        <a href="#"
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a
                            href="#">{{$staticContent['EOL'] ?? 'EOL'}}</a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<section class="box-news">
    <div class="container">
        <h1 class="text-title-delta ">{{$staticContent['EOL'] ?? 'EOL'}}</h1>
