        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#">{{$staticContent['Partners_Login']}}</a></li>
...
{{-- <div class="visible-tablets-up visible-mobile"> --}}
    <div class="box-login pb-5">
        <div class="container">
            <h2 class="text-title-delta">{{$staticContent['Partners_Login']}}</h2>
            ...
            {{csrf_field()}}
                <div class="center">
                    <div id="requestemail" class="col-sm-6 w-100 mx-auto mb-3">
                        ...
                        <input type="email" class="input-login" name="email" id="inputEmail" placeholder="{{$staticContent['Email_Address']}}" required>
                    </div>
                    
                    <div id="requestpassword" class="col-sm-6 w-100 mx-auto mb-3">
                        <label class="text-title-detail-dark">{{$staticContent['Password']}}*</label>
                        <input type="password" class="input-login" name="password" id="inputPassword" pattern="{8,}" title="Must at least 8 or more characters" placeholder="{{$staticContent['Password']}}" required>
                    </div>
                ...
                <div class="w-100 text-center mb-3">
                    <a data-toggle="modal" data-target="#confirm-email-forgot-pass" class="btn-forget">{{$staticContent['Forgot_Password']}}</a>
