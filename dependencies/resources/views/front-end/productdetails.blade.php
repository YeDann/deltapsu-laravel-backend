            ...
            <div>
                ...
                ?>
                    ...
                    <div class="data-sheet-downloade d-flex justify-content-between ">
                        ...
                        <a data-toggle="modal" data-target="#downloadgui-modal" onclick="downloadGUI('{{$item->file}}','{{setTextpro($product[0]['pro_code'])}}')" href="{{route('downloadFIle',[$item->slug,setTextpro($product[0]['pro_code'])])}}" target="_blank">
                        <button class="btn-downlode">{{$staticContent['Downloads']}}</button>
                        </a>
                    </div>
                    @endif
