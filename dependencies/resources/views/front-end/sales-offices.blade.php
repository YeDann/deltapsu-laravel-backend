    ...
    <div class="container">
        ...
        <div id="sales-offices" class="sales-offices-type">
            ...
            <div class="box-for-collap">
                <div class="sales-offices-list collapsed  hide-box text-colour-delta" data-toggle="collapse"
                    data-parent="#sales-offices-type" href="#collapse-ofictab{{$item->id}}">
                    <h5>{{$item->name}}</h5>
                </div>
                <div id="collapse-ofictab{{$item->id}}" class="sales-offices-list-sub collapse"
                    ...
                    <div class="force-overflow">
                        ...
                        <div class="sales-offices-address">
                            ...
                            <a href="https://www.google.com/maps/?q={{$office->lat}},{{$office->lon}}&sensor=true"
                                target="_blank"><button class="btn-subscribe">{{isset($staticContent['GetDirection'])?
            ...
            {{-- <div class="box-for-collap">
                <div class="sales-offices-list collapsed  hide-box text-colour-delta" data-toggle="collapse"
                    data-parent="#sales-offices-type" href="#collapse-india">
            ...
            <div class="box-for-collap">
                <div class="sales-offices-list collapsed  hide-box text-colour-delta" data-toggle="collapse"
                    data-parent="#sales-offices-type" href="#collapse-europe">
            ...
            <div class="box-for-collap">
                <div class="sales-offices-list collapsed  hide-box text-colour-delta" data-toggle="collapse"
                    data-parent="#sales-offices-type" href="#collapse-america">
                ...
                <div id="collapse-america" class="sales-offices-list-sub collapse" data-parent="#sales-offices-type">
                    <div class="force-overflow">
                        <div class="sales-offices-address">
                            <p class="text-sixteen-dark mr-b-1">Delta Electronics (Americas) Ltd. <br>North America
                                Headquarters </p>
                            <p>46101 Fremont Blvd. Fremont, CA 94538, U.S.A
                                <br>Tel: +1 510 668 5100
                            </p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                    </div>
            ...
            <div class="box-for-collap">
                <div class="sales-offices-list collapsed  hide-box text-colour-delta" data-toggle="collapse"
                    data-parent="#sales-offices-type" href="#collapse-central">
                    ...
                    <div class="force-overflow">
                        <div class="sales-offices-address">
                            ...
                            <p>Rua Itapeva, 26 -3° andar - Bela Vista 01332-000 São Paulo/SP - Brasil
                                ...
                                <br>Fax: +55 11 3568 3865
                            </p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                        <div class="sales-offices-address">
                            <p class="text-sixteen-dark mr-b-1">Delta Electronics International Mexico, S.A. de C.V.</p>
                            <p>Centrum Park, Av. Gustavo Baz Prada 309, Edificio E Planta Baja Col. La Loma, C.P. 54030
                                Tlalnepantla,
                                <br>Estado de México
                                <br>Tel: +52 55 3603 9200
                            </p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                    </div>
            ...
            <div class="box-for-collap">
                <div class="sales-offices-list collapsed  hide-box text-colour-delta" data-toggle="collapse"
                    data-parent="#sales-offices-type" href="#collapse-australia">
