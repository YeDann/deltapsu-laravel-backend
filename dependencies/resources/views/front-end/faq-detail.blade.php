...
<meta property="og:title" content="{{isset($metatag[0]->meta_title)? $metatag[0]->meta_title :''}}" />
<meta property="og:description" content="{!! iconv_substr(strip_tags(isset($faqs[0]->title)? $faqs[0]->title:''),0,90,'UTF-8') !!}" />
        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-breadcrumb" aria-current="page"><a href="{{route('index','faqs')}}">{{$staticContent['FAQs']}}</a></li>
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#"> {{isset($faqs[0]->title)? $faqs[0]->title:'' }}</a></li>
                </ol>
            </nav>
        </div>
    </div>
