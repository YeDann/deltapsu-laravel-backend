...
<style>
    ...
    /* Search / See More 另加大高度 40px、圓角 5px，並用 flex 垂直置中，避免 JP/SC/TC 長字被切或偏上 */
    ...
    .btn.btn-boxen { font-size: 18px; }
    .btn-filters.btn-addremove-filer { font-size: 16px; border-radius: 5px; }
