        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#">{{$staticContent['find_a_distributor']}}</a></li>
    ...
    <div class="container">
        ...
        <div id="find-distributor" class="find-distributor-type">
            ...
            <div class="find-distributor-list collapsed  hide-box text-colour-delta" data-toggle="collapse" data-parent="#find-distributor-type"
                ...
                <div id="collapse-ofictab{{$item->id}}" class="find-distributor-list-sub collapse" data-parent="#find-distributor-type">
                        <div class="force-overflow">
                            ...
                            <div class="sales-offices-address">
                             ...
                             <a href="https://www.google.com/maps/?q={{$office->lat}},{{$office->lon}}&sensor=true" target="_blank"><button class="btn-subscribe mt-2" >{{$staticContent['Get Direction']}}</button></a>
            ...
            @endforeach
            {{-- <div class="box-for-collap">
                <div class="find-distributor-list collapsed  hide-box text-delta" data-toggle="collapse" data-parent="#find-distributor-type"
                        href="#collapse-fad-americas" >
                      
                        <h5>AMERICAS</h5>
                       
                </div>
                <div id="collapse-fad-americas" class="find-distributor-list-sub collapse" data-parent="#find-distributor-type">
                        <div class="force-overflow">
                            <div class="find-distributor-address">
                                ...
                                <br>Link: https://www.arrow.com/en/products/manufacturers/d/delta-electronics</p>
                            ...
                            <div class="find-distributor-address">
                                ...
                                <br>Link: http://avnetexpress.avnet.com/store/em/EMController/Delta-Corp/_/N-4280354008?action=products&storeId=500201&langId=-1&sel=M</p>
                                <button class="btn-subscribe">GET DIRECTION</button>
                            </div>
                            <div class="find-distributor-address">
                                ...
                                <br>Link: http://www.digikey.com/Suppliers/us/Delta-Product-Groups-Power.page  </p>
                                <button class="btn-subscribe">GET DIRECTION</button>
                            </div>
                            <div class="find-distributor-address">
                                ...
                                <br>Link: http://www.masterelectronics.com/suppliers/delta-psu-1378/</p>
                                <button class="btn-subscribe">GET DIRECTION</button>
                            </div>
                            <div class="find-distributor-address">
                                ...
                                <br>Link: http://www.mouser.com/delta-electronics/</p>
                                <button class="btn-subscribe">GET DIRECTION</button>
                            </div>
                            <div class="find-distributor-address">
                                ...
                                <br>Web: http://www.nrcelectronics.com</p>
                                <button class="btn-subscribe">GET DIRECTION</button>
                            </div> 
                        </div>
                </div>
            ...
            <div class="box-for-collap">
                <div class="find-distributor-list collapsed  hide-box text-delta" data-toggle="collapse" data-parent="#find-distributor-type"
                    href="#collapse-fad-europe">
                    
                    <h5>EUROPE</h5>
                </div>
                <div id="collapse-fad-europe" class="find-distributor-list-sub collapse" data-parent="#find-distributor-type">
                    <div class="force-overflow">
                        <div class="find-distributor-address">
                        ...
                        <div class="find-distributor-address">
                            ...
                            <br>Web: http://www.neumueller.com</p>
                            <button class="btn-subscribe">GET DIRECTION</button> 
                        </div>
                        <div class="find-distributor-address">
                            ...
                            <br>Web: http://www.sge-syscom.com</p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-for-collap">
                <div class="find-distributor-list collapsed  hide-box text-delta" data-toggle="collapse" data-parent="#find-distributor-type"
                    href="#collapse-fad-japan">
                   
                    <h5>JAPAN</h5> 
                </div>
                <div id="collapse-fad-japan" class="find-distributor-list-sub collapse" data-parent="#find-distributor-type">
                    <div class="force-overflow">
                        <div class="find-distributor-address">
                            ...
                            <br>Web: https://www.oec.okaya.co.jp/</p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                        <div class="find-distributor-address">
                            ...
                            <br>Web: http://www.microsol.co.jp/index.html</p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                        <div class="find-distributor-address">
                            ...
                            <br>Web: http://www.tsuzuki.co.jp</p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                        <div class="find-distributor-address">
                            ...
                            <br>Web: http://www.bellnix.co.jp/</p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-for-collap">
                <div class="find-distributor-list collapsed  hide-box text-delta" data-toggle="collapse" data-parent="#find-distributor-type"
                    href="#collapse-fad-korea">
                   
                    <h5>KOREA</h5>    
                </div>
                <div id="collapse-fad-korea" class="find-distributor-list-sub collapse" data-parent="#find-distributor-type">
                    <div class="force-overflow">
                        <div class="find-distributor-address">
                            ...
                            <br>Web: http://www.bluecosmos.co.kr</p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                        <div class="find-distributor-address">
                        ...
                        <div class="find-distributor-address">
                            ...
                            <br>Web: http://www.deltapsu.co.kr/</p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                    </div>
                </div>
            ...
            <div class="box-for-collap">
                <div class="find-distributor-list collapsed  hide-box text-delta" data-toggle="collapse" data-parent="#find-distributor-type"
                    href="#collapse-fad-taiwan">
                   
                    <h5>TAIWAN</h5>   
                </div>
                <div id="collapse-fad-taiwan" class="find-distributor-list-sub collapse" data-parent="#find-distributor-type">
                    <div class="force-overflow">
                        <div class="find-distributor-address">
                        ...
                        <div class="find-distributor-address">
                            ...
                            <br>Web: http://www.honyabiz.com.tw</p>
                            <button class="btn-subscribe">GET DIRECTION</button>
                        </div>
                        <div class="find-distributor-address">
            ...
            <div class="box-for-collap">
                <div class="find-distributor-list collapsed  hide-box text-delta" data-toggle="collapse" data-parent="#find-distributor-type"
                    href="#collapse-fad-thailand">
                    
                    <h5>THAILAND</h5>    
                </div>
                <div id="collapse-fad-thailand" class="find-distributor-list-sub collapse" data-parent="#find-distributor-type">
                    <div class="force-overflow">
                        <div class="find-distributor-address">
