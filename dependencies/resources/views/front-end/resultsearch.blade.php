        ...
        <div class="bar-product-type">
            <nav id="bar-search-results-page-nav">
                <div class="nav nav-tabs mb-4" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-tab0" data-val="0" data-toggle="tab" href="#nav-products" role="tab" aria-controls="nav-products" aria-selected="true">{{$staticContent['Products']}} ({{count($pro_results)}})</a>
                    <a class="nav-item nav-link" id="nav-tab1" data-val="1" data-toggle="tab" href="#nav-news" role="tab" aria-controls="nav-news" aria-selected="false">{{$staticContent['Product_News']}} ({{count($news)}})</a>
                    <a class="nav-item nav-link" id="nav-tab2"  data-val="2" data-toggle="tab" href="#nav-events" role="tab" aria-controls="nav-events" aria-selected="false">{{$staticContent['Events']}} ({{count($events)}})</a>
                    {{-- <a class="nav-item nav-link" id="nav-tab3"  data-val="3" data-toggle="tab" href="#nav-technical-articles" role="tab" aria-controls="nav-technical-articles" aria-selected="false">{{$staticContent['Technical_Articles']}} ({{count($articles)}})</a> --}}
                    <a class="nav-item nav-link" id="nav-tab7"  data-val="7" data-toggle="tab" href="#nav-applications" role="tab" aria-controls="nav-applications" aria-selected="false">{{$staticContent['Applications']}} ({{count($applications)}})</a>
                    <a class="nav-item nav-link" id="nav-tab4" data-toggle="tab"  data-val="4" href="#nav-faqs" role="tab" aria-controls="nav-faqs" aria-selected="false">{{$staticContent['FAQs']}}  ({{count($faqs)}})</a>
                    <a class="nav-item nav-link" id="nav-tab5" data-val="5"  data-toggle="tab" href="#nav-marketing-resources" role="tab" aria-controls="nav-marketing-resources" aria-selected="false">{{$staticContent['Marketing_Resources']}}  ({{count($margeting)}})</a>
                    <a class="nav-item nav-link" id="nav-tab6"  data-val="6" data-toggle="tab" href="#nav-contact-info" role="tab" aria-controls="nav-contact-info" aria-selected="false">{{$staticContent['contact_Info']}} ({{count($distributor)+count($offices)}})</a>
                              ...
                              ?>
                                ...
                                <div class="item card">
                                    ...
                                    <div class="card-body ft-products-item">
                                        ...
                                        <a href="{{route('productsDetailsByType' ,['catename'=> $pro['url_item']  ,'pro_code' => checkProcode($pro['pro_code']) ])}}">
                                       <div class="pro-h-box">
                                        ...
                                        <div class="dimension">
                                            ...
                                            @if(is_numeric($pro['dimensionL']) && is_numeric($pro['dimensionW'])  && is_numeric($pro['dimensionD']) && isset($pro['dimensionW']) && isset($pro['dimensionD']))
                             ...
                             <div class="d-flex flex-wrap">
                                ...
                                <div class=" margin-p-left-card  col-card-product">
                                    <div class="item card">
                                       ...
                                       <div class="new-tag" style="background-color:{{$color}}">{{$name_sta}}</div>
                                        <div class="card-body ft-products-item">
                                            <a href="{{route('productsDetailsByType' ,['catename'=> preg_replace('/\s+/', '-', $pro['url_item']) ,'pro_code' =>  checkProcode($pro['pro_code'])])}}">
                                                @if(isset($pro['picture']))
                                                <img src="{{config('app.url')}}/upload/thumbs/{{$pro['picture']}}" class="product-cat mb-2" alt=""
                                                    style="width:70%;">
                                                @else
                                            ...
                                            <div class="flex-row">
                                                ...
                                                <div class="in-volt mt-2">
                                                    ...
                                                    <p class="text-ft-sub text-two"> {!! iconv_substr(strip_tags($pro['content'][3]->value_text),0,15,'UTF-8') !!} ...</p>
                                                   
                                                </div>
                                                <div class="dimension mt-2">
                                                    <p class="text-title-ft-sub text-two"> {{$staticContent['Dimensions']}}</p>
                                                    @if(is_numeric($pro['dimensionL']) && is_numeric($pro['dimensionW'])  && is_numeric($pro['dimensionD']) &&  isset($pro['dimensionW']) && isset($pro['dimensionD']))
                                                    <p class="text-ft-sub text-one">{{$pro['dimensionL']}} x {{$pro['dimensionW']}} x
                                                        {{$pro['dimensionD']}} mm</p>
                                                    <p class="text-ft-sub text-one">
                ...
                <div class="box-news tab-pane fade" id="nav-news" role="tabpanel" aria-labelledby="nav-news-tab">
                    <div id="result2" class="row">
                        ...
                        <div class="col-md-6 col-lg-4 mb-4">
                            ...
                            <a href="{{route('updateNewsDetail',['name'=> $item->slug])}}" class="read-more">{{$staticContent['Read_More']}}</a>
                            </div>
                          </div>  
                        @endforeach
                ...
                <div class="tab-pane fade row" id="nav-faqs" role="tabpanel" aria-labelledby="nav-faqs-tab">
                    <div id="result5" class="faqs-type w-100">
                        @foreach ($faqs as $faq)
                            ...
                            <div class="faqs-list hide-box collapsed" data-toggle="collapse" data-parent="#faqs-type" href="#collapse-faq{{$faq->id}}" aria-expanded="false">
                                   <div class="p-l-18">{{$faq->title}}</div>

                                </div>
                                <div id="collapse-faq{{$faq->id}}" class="faqs-list-sub collapse" data-parent="#faqs-type" style="">
                    ...
                    <div id="result6" class="ft-products-body w-100 faqs-type">
                       ...
                       ?>
                        ...
                        <div class="resources-download ">
                            ...
                            <a href="{{config('app.url')}}/medias/marketing_resources/{{isset($current->file)? $current->file:""}} ">
                       ...
                       <div class="sales-offices  ">
                            ...
                            <div class="sales-offices-type pb-5">
                                ...
                                <div class="sales-offices-list  hide-box text-colour-delta" data-toggle="collapse" data-parent="#sales-offices-type"
                                            href="#collapse-sales{{$con_f->id}}" >
                                               <h5>{{$con_f->name}}</h5>
                                           
                                    </div>
                                    <div id="collapse-sales{{$con_f->id}}" class="sales-offices-list-sub collapse show" data-parent="#sales-offices-type">
                                        <div class="force-overflow">
                                            @foreach ($offices as $offic)
                                            @if($offic->continent_id == $con_f->id )
                                            <div class="sales-offices-address">
                                                <p class="text-sixteen-dark mr-b-1">{{$offic->title}}
                                                <br>{{$offic->sub_title}}</p>
                                               <div class="text-editor"> 
                                                  {!!$offic->content!!}
                                               </div>
                                               <a href="https://www.google.com/maps/?q={{$offic->lat}},{{$offic->lon}}&sensor=true" target="_blank">
                                                <button class="btn-subscribe"> {{$staticContent['Get Direction']}}</button>
                                               </a>
                                            </div> 
                                            @endif
                                            @endforeach                                        
                       ...
                       <div class="find-distributor">
                            ...
                            <div id="find-distributor" class="find-distributor-type">
                                ...
                                <div class="find-distributor-list  hide-box text-colour-delta " data-toggle="collapse" data-parent="#find-distributor-type"
                                    ...
                                    <div id="collapse-fad-offi{{$con_dis->id}}" class="find-distributor-list-sub collapse show" data-parent="#find-distributor-type">
                                            <div class="force-overflow">
                                                @foreach ($distributor as $dis)
                                                @if($dis->continent_id == $con_dis->id )
                                                <div class="find-distributor-address">
                                                    ...
                                                    <div class="text-editor mb-2"> 
                                                     ...
                                                     <a href="https://www.google.com/maps/?q={{$dis->lat}},{{$dis->lon}}&sensor=true" target="_blank">
                                                    <button class="btn-subscribe"> {{$staticContent['Get Direction']}}</button>
                                                     </a>
                                                     @if($dis->status_cer == 1)
                                                     <a href="{{config('app.url')}}/medias/distributor/{{$dis->file_cer}}" download="">
                                                      <button class="btn-certi"><i class="cer-icon icon-facon icon-web-certificate"></i> <span class="f-btn">{{$staticContent['Certificates']}}</span></button>
                                                      </a>
                                                      @endif
                                                </div>
                                                @endif
