                ...
                <ol class="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active text-breadcrumb-home" aria-current="page"><a
                                href="{{route('marketingResources')}}">{{$staticContent['Marketing_Resources']}}</a>
                        </li>
                        <li class="breadcrumb-item active text-breadcrumb-home" aria-current="page"><a
                                href="{{route('successStories')}}">{{$staticContent['Success_Stories']}}</a></li>
                        <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a
                                href="#">{{$staticContent['edit']}}</a></li>
                    </ol>
                </ol>
            </nav>
        </div>
...
<div class="mb-5">
    ...
    <div class="container">
        <form id="form-success-story" action="{{route('updateSuccessStories')}}" method="POST"
            enctype="multipart/form-data">
            {{csrf_field()}}
            <h2 class="text-title-delta visible-up-922">{{$staticContent['edit']}} {{$staticContent['Success_Stories']}}
            </h2>
            <h3 class="text-title-delta invisible-up-922">{{$staticContent['edit']}}
                {{$staticContent['Success_Stories']}}</h3>
            <div class="row">
                ...
                <div class="col-lg-6 col-md-12 input-label w-100 mb-4">
                    ...
                    {{-- <input type="text" class="form-control" name="model" placeholder="{{$staticContent['Model']}}"
                        required> --}}
                    <select class="js-example-basic-multiple form-control" name="model[]" multiple="multiple" id="model"
                        required>
                        <option></option>
            ...
            <div class="row">
                <div class="col-12">
                    <label class="text-title-detail-dark">{{$staticContent['Old_Image']}}<span
                            class="red">*</span></label>
                </div>
            </div>
            <div class="row mb-4">
