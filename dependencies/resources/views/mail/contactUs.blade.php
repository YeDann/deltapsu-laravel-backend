                                            ...
                                            <p style="Margin-top: 0;Margin-bottom: 20px;">
                                                <table>
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td> {{isset($contactForm['country']) ? $contactForm['country'] :'-' }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td style="width: 180px;">City / State : </td>

                                                            <td> {{isset($contactForm['state']) ? $contactForm['state'] :'-' }}</td>
                                                        </tr>

                                                        <tr>
                                                            <td style="width: 180px;">Product Type : </td>
                                                            <td>{{$contactForm['type_name']}}</td>
                                                        </tr>
                                                        <tr>
                                                ...
                                                <div style="max-width:600px;color: #444444;font-size: 16px;">
                                                    ...
                                                    <span style="color: #444444;font-size: 14px;">
                                                        {{isset($contactForm['message']) ? $contactForm['message'] :'-' }}
                                                    </span>
                                                </div>
                                                {{-- <div style="max-width:300px;color: #444444;font-size: 16px;"></div> --}}
                                            </p>
                                        </div>
                                    </div>
                                </div>
