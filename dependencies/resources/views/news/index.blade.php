    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">
                ...
                <a href="{{route('newstype.index')}}" class="btn btn-info">Product News Type</a>
            </h3>
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="{{route('news.create')}}" class="btn btn-success"><i class="fa fa-plus"></i> Create </a>
                    {{-- <a href="{{route('ImportNewsData','news')}}" class="btn btn-info" > GET Data </a> --}}
                    ...
                    <td class="text-center">
                        <div class="">
                            ...
                            <button type="button" class="btn btn-danger" data-toggle="tooltip" id="delbutton"
                                title="Delete" data-fn-click="deleteNews" data-fn-args='[{{$item->id}}]'>
                                Delete
                            </button>
                        </div>
                    </td>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "{{ (route('destroyNews')) }}/" + id;
                });
            }
        });
    }
