    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">
                ...
                <a href="{{route('technical-type.index')}}" class="btn btn-info">Type</a>
            </h3>
    ...
    <div class="modal-dialog modal-dialog-popin" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mt-0">
                ...
                <form action="{{route('copyTechnical')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
    ...
    <div class="modal-dialog modal-dialog-popin" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mt-0">
                ...
                <form action="{{route('copyTechnicalsingle')}}" method="POST" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="block-content">
                        <div class="block-options-item form-group">
                            <label for="">Select language for Duplicate</label>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "{{ (route('destroyTechnical')) }}/" + id;
                });
            }
        });
    }
