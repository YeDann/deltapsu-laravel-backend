            ...
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-center"><a href="{{route('contact-zone.show','sell-office')}}"
                    ...
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-center"><a href="{{route('contact-zone.show','distributors')}}"
