...
<div class="content">
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">Create Product Notice Type</h3>
        </div>
        <div class="block-content">
            <form action="{{route('product-notice-type.store')}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <!-- Basic Elements -->
                <div class="row push">
                    <div class="col-lg-12">
                            ...
                            <div class="block-content tab-content">
                                ...
                                <div class="tab-pane {{($loop->iteration == 1)?"active":""}}" id="btabs-alt-static-{{$item->name}}" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="title[{{$item->name}}]" placeholder="Type name..." required>
                                    </div>
                                </div>
                                @endforeach
                            </div>
