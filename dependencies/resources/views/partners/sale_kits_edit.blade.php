    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <a href="{{route('partner_doc_index' ,[$type_id ,$type_name])}}">Edit
                            {{$type_name}}</a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                                ...
                                <div class="tab-pane {{($loop->iteration == 1)?" active":""}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name[{{$item->name}}]"
                                            ...
                                            value="{{isset($current->name)?$current->name :''  }}" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file " style="width:100%;">
                                            <input type="file" class="custom-file-input"
                                                name="filesale[{{$item->name}}]" data-toggle="custom-file-input">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="js-datepicker form-control {{ $errors->has('date') ? 'is-invalid' : '' }}"
                                data-week-start="1" data-autoclose="true" data-today-highlight="true"
                                data-date-format="yyyy-mm-dd" value="{{$sales_kits[0]->date_info}}"
