    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    @if(isset($AllsuccessStory) and !empty($AllsuccessStory))
                    @foreach ($AllsuccessStory as $item)
                    <td class="text-center">{{$loop->iteration}}</td>
                    <td class="d-none d-sm-table-cell">{{$item->modelname}}</td>
                    <td class="d-none d-sm-table-cell">{{$item->application}}</td>
                    <td class="d-none d-sm-table-cell">{{$item->endCustomer}}</td>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="{{route('deteleteSuccessStories')}}" method="POST" >
                        {{csrf_field()}}
