...
<div class="bg-body-light">
    <div class="content content-full">
        ...
        <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">{{$type_name}}</h1>
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="{{route('partner_doc_create' ,[$type_id,$type_name])}}" class="btn btn-success">Create</a>
        ...
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    @if(isset($sales_kits) and !empty($sales_kits))
                    @foreach ($sales_kits as $item)
                    <td class="text-center">{{$loop->iteration}}</td>
                    <td class="d-none d-sm-table-cell">{{$item->name}}</td>
                    <td class="d-none d-sm-table-cell">{{$item->date_info}}</td>
                    <td class="text-center">
                        <a href="{{route('partner_doc_edit', [$item->id ,$type_id,$type_name])}}" class="btn btn-primary">Edit</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="{{route('deleteSaleKit')}}" method="POST" >
                        {{csrf_field()}}
