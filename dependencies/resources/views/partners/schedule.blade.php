    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('pro_lauch')}}">All Product Launch Schedule</a></li>
    ...
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    @if(isset($pro_launch_sche_mo) and !empty($pro_launch_sche_mo))
                    @foreach ($pro_launch_sche_mo as $item)
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="{{route('scheduleDelete')}}" method="POST" >
                        {{csrf_field()}}
                    <div class="block-content">
                        <input type="hidden" name="pl_fk_id" id="pl_fk_id" value="{{$headId}}">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="{{route('scheduleUpdate')}}" method="POST" >
                        {{csrf_field()}}
                    <div class="block-content">
                    <input type="hidden" name="pl_fk_id" id="pl_fk_id" value="{{$headId}}">
                    <input type="hidden" name="pl_m_id" id="pl_m_id" value="">
                        <label for="example-text-input"><span class="req-fed">*</span>Month / Date</label>
                        <input type="text" id="data_date" class="js-datepicker form-control {{ $errors->has('date') ? 'is-invalid' : '' }}"  data-week-start="1" data-autoclose="true"
                            data-today-highlight="true" data-date-format="yyyy-mm-dd" placeholder="yyyy-mm-dd" name="date" required>
                    </div>
                    <div class="block-content block-content-full text-right bg-light">
                        <button type="button" class="btn  btn-light" data-dismiss="modal">Close</button>
