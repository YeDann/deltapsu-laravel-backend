                    ...
                    <div class="col-md-12">
                            ...
                            <div class="tab-pane {{$loop->iteration == 1 ?'active':''}}" id="btabs-alt-static-{{$item->name}}" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="name[{{$item->name}}]" value="{{isset($current->name)?$current->name :''}}"
                                            placeholder="Enter name...">
                                    </div>
                                     <div class="form-group">
                                        <label for="">Overview</label>
                                        <textarea name="overview_text[{{$item->name}}]" rows="2" class=" form-control">{{isset($current->overview_text)?$current->overview_text :''}}</textarea>
                                    </div>
                                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                ...
                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-2" name="status" value="0" {{$contents[0]->status == 0 ?"checked":""}}>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{config('app.url')}}/medias/categories/{{$contents[0]->color_icon}}"
                                                ...
                                                <input type="hidden" name="oldfile[color_icon]" value="{{$contents[0]->color_icon}}" >
                                        </td>
                                    ...
                                    <tr class="">
                                            ...
                                            <td class="text-center">
                                                    <img src="{{config('app.url')}}/medias/categories/{{$contents[0]->blue_outline_icon}}"
                                                        class="img-thumbnail res-image" alt="">
                                                        <input type="hidden" name="oldfile[blue_outline_icon]" value="{{$contents[0]->blue_outline_icon}}" >
                                                </td>
                                            <td class="font-w600">
                                                <img src="https://via.placeholder.com/72x72.png"
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{config('app.url')}}/medias/categories/{{$contents[0]->thumbnail}}"
                                                class="img-thumbnail res-image" alt="">
                                                <input type="hidden" name="oldfile[thumbnail]" value="{{$contents[0]->thumbnail}}" >
                                        </td>
                                        <td class="font-w600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="{{config('app.url')}}/medias/categories/{{$contents[0]->banner}}"
                                                class="img-thumbnail res-image" alt="">
                                                <input type="hidden" name="oldfile[banner]" value="{{$contents[0]->banner}}" >
                                        </td>
                                        <td class="font-w600">
