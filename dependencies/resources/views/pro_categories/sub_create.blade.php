                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" class="form-control" name="contentAddType1"> </textarea>
                        </div>

                        <div class="form-group">
                            <label for="example-select">Overview(Industrial Power)</label>
                            <textarea rows="4" class="form-control" name="contentAddType2"> </textarea>
                        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            <div class="custom-file">
                                                ...
                                                <label id="labelType1 class=" custom-file-label" for="thumbnail3">Choose
                                                    file</label>
                                            </div>
                                        </td>
                                    </tr>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control " name="unit_dimension" value="D" maxlength="2"
                    ...
                    {{-- <div class="col-lg-8 pt-2">
                        ...
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" id="example-select2-multiple" name="productfield[]"
