                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="4" class="jsnotenew" name="overview"> </textarea>
                        </div>
                    ...
                    <div class="col-lg-8 pt-2">
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" id="example-select2-multiple"
                                name="mainCategories[]" style="width: 100%;" data-placeholder="Choose many.." multiple
                                required>
                                <option></option>
                    ...
                    <div class="col-lg-8 pt-2">
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" id="example-select2-multiple"
                                name="productCategories[]" style="width: 100%;" data-placeholder="Choose many.."
                                multiple required>
                                <option></option>
                                <!-- Required for data-placeholder attribute to work with Select2 plugin -->
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status_mode{{$mode->id}}"
                                    name="status_mode" value="{{$mode->id}}">
                                <label class="custom-control-label"
                                    for="status_mode{{$mode->id}}">{{$mode->name}}</label>
                            </div>
                            @endforeach
                        </div>
                    </div>
                    ...
                    <div class="col-lg-8 pt-2">
                        <div class="form-group">
                            ...
                            <select class="js-select2 form-control" id="example-select2-multiple" name="aplication[]"
                            ...
                            <div class="mt-2">
                                <a class="btn btn-outline-primary" href="{{route('application-view.index')}}"> *Add
                                    application</a>
                            </div>
                        </div>
                    </div>
