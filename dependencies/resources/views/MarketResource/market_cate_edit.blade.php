    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <a href="{{route('MarketResourceCategories.index')}}">All Marketing
                            Resource Categories</a></li>
                ...
                <div class="row push">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="checkbox" class="custom-control-input" id="status-role1" name="role[]"
                                    value="1" {{ isset($per1) ?"checked":""}}>
                                <label class="custom-control-label" for="status-role1">Distributor</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="checkbox" class="custom-control-input" id="status-role2" name="role[]"
                                    value="2" {{ isset($per2) ?"checked":""}}>
                                <label class="custom-control-label" for="status-role2">FES</label>
                            </div>
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="checkbox" class="custom-control-input" id="status-role3" name="role[]"
                                    value="3" {{ isset($per3) ?"checked":""}}>
