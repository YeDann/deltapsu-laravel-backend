...
class ContentSecurityPolicy
{
    public function handle(Request $request, Closure $next)
    {
        ...
        $cspDirectives = [
            ...
            "img-src 'self' data: https://px.ads.linkedin.com https://cookiecdn.com https://www.deltapsu.com https://deltapsu.com",
            "object-src 'none'",
