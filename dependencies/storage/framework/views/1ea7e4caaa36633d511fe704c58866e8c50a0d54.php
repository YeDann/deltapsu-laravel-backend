...
<main id="main-container">
        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                ...
                <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('successStory')); ?>">Back</a></li>
    ...
    <div class="content">
                            ...
                            <div class="row">
                                <div class="col-lg-4">
                                    ...
                                    <p style="color:red"> *.png .jpeg<p>
                                            <p style="color:red">  Max File size 2 MB<p>
                                </div>
                                ...
                                <form class="dropzone" id="my-awesome-dropzone"  method="post" enctype="multipart/form-data">
                                    ...
                                    <input type="hidden" name="story_id" id="story_id" value="<?php echo e($story_id); ?>">
                                    </form>
                                </div>
                            </div>
                        </div>
        ...
        <div class="block block-rounded block-bordered">
            ...
            <button type="button" class="btn btn-hero-primary" data-toggle="modal" data-target="#modal-block-create" onclick="createimage();">+ Add Image</button></a>
            ...
            <div class="block-content block-content-full">
                <table class="table table-bordered table-striped table-vcenter">
                    ...
                    <tbody>
                        <?php  $i = 1 ?>
                        <?php $__currentLoopData = $image_story; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td class="text-center"><?php echo e($i); ?></td>
                            <td class="font-w600">
                              <img src="<?php echo e(config('app.url')); ?>/medias/marketing_resources/<?php echo e($data->image); ?>" width="120px;">
                            </td>
                                <td>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <form action="<?php echo e(route('deleteImageStory_back')); ?>" method="POST">
                    <?php echo e(csrf_field()); ?>
...
<script>
        ...
        var myDropzone = new Dropzone("#my-awesome-dropzone", { 
            url: "<?php echo e(route('uploadImageStory')); ?>"}
            );
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/partners/imageStory.blade.php ENDPATH**/ ?>