        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-breadcrumb"><a href="<?php echo e(route('index','partners')); ?>"><?php echo e($staticContent['Partners']); ?></a></li>
...
<script>
        ...
        function getContentByModel(method){
            ...
            html2 += ' <div class="box-for-collap">'
                ...
                html2 += '<p class="text-dark"><?php echo e($staticContent['Uploaded_on']); ?> '+setformatdate(doc['created_at']) +'</p>';
                html2 += '</div>';
                html2 += '<a href="<?php echo e(config('app.url')); ?>/upload/product_files/'+doc['file'] +'" target="_blank">';
                html2 += '<button class="btn-downlode "><?php echo e($staticContent['Downloads']); ?></button>';
                html2 += ' </a>' ;
                html2 += ' </div>' ;
                    }
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/login-pro-document.blade.php ENDPATH**/ ?>