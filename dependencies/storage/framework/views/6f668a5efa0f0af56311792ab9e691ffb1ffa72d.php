        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#"><?php echo e($staticContent['Sales_kit']); ?></a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="box-events mb-5">
    <div class="container">
        <h2 class="text-title-delta visible-up-922"><?php echo e($staticContent['Sales_kit']); ?></h2>
        <h3 class="text-title-delta invisible-up-922"><?php echo e($staticContent['Sales_kit']); ?></h3>
        <p class="text-center mb-5" ><?php echo e($staticContent['Sales_Kit_will_help_technicians']); ?></p>
        <div class="content-seles-kit">
            <?php $__currentLoopData = $product_docs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a href="<?php echo e(config('app.url')); ?>/medias/marketing_resources/<?php echo e($item->file); ?>" download="<?php echo e($item->name); ?><?php echo e($item->date_info); ?>"><button class="btn-downlode "><?php echo e($staticContent['Downloads']); ?></button></a>
                </div>
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/sale-kit.blade.php ENDPATH**/ ?>