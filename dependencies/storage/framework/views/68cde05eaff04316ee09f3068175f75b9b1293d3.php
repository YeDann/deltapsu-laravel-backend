    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="<?php echo e(route('orderSeries' ,$pro_cate_id)); ?>" class="btn btn-outline-info">Order Series</a>
                    <a href="<?php echo e(route('createSeries' ,$pro_cate_id)); ?>" class="btn btn-success">Create</a>
        ...
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="d-none d-sm-table-cell"><?php echo e($item->slug); ?></td>
                    <td class="d-none d-sm-table-cell"><?php echo e($item->status == 1?'Show':'Hide'); ?></td>
                    <td class="text-center">
                        <div class="">
                                <a href="<?php echo e(route('editSeries' ,['id'=>$item->se_id ,'cateId'=>$pro_cate_id ])); ?>" class="btn btn-primary">Edit</a>
                                <button type="button" class="btn btn-danger" onclick="ondelelete(<?php echo e($item->se_id); ?>);" data-toggle="modal" data-target="#modal-block-vcenter">Delete</button>
                            </div>
                    </td>
                    </tr>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="<?php echo e(route('destroySeries')); ?>" method="POST" >
                        <?php echo e(csrf_field()); ?>

                      
                    <div class="block-content">
                    <input type="hidden" name="pro_cate_id" id="pro_cate_id" value="<?php echo e($pro_cate_id); ?>">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/pro_categories/series.blade.php ENDPATH**/ ?>