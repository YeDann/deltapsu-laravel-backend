        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#"> <?php echo e($staticContent['Product_launch_Schedule']); ?></a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="box-events mb-5">
    <div class="container">
        <h2 class="text-title-delta visible-up-922"><?php echo e($staticContent['Product_launch_Schedule']); ?></h2>
        <h3 class="text-title-delta invisible-up-922"><?php echo e($staticContent['Product_launch_Schedule']); ?></h3>
                ...
                <table id="" class="table " cellspacing="5em" width="100%">
                    <thead>
                        <tr class="headder-bg-table">
                            ...
                            <th class="th-sm header-font-table text-center"><?php echo e($staticContent['Launch_Date']); ?></th>
                            <th class="th-sm header-font-table text-center"><?php echo e($staticContent['Op_Voltage']); ?></th>
                            <th class="th-sm header-font-table text-center"><?php echo e($staticContent['Op_Power']); ?></th>
                            <th class="th-sm header-font-table text-center"><?php echo e($staticContent['Phase']); ?></th>
                            <th class="th-sm header-font-table text-center"><?php echo e($staticContent['Remarks']); ?> </th>
                            <th class="th-sm header-font-table text-center"><?php echo e($staticContent['Prelim_DS']); ?></th>
                        </tr>
                    </thead>
    ...
    function loadproductLaunch(date){
        ...
        $.each(pro_launch_schedules, function(index,pro_launch){
         if(checkDateDate(pro_launch['monthdate'] ,date)){
            ...
            html += '<td class="text-middle-td"> <a href="<?php echo e(config('app.url')); ?>/medias/marketing_resources/'+pro_launch['file']+'" download > <div class="btn btn-ft w-100"> <?php echo e($staticContent['Downloads']); ?></div></td>';
            html += '</tr>';
            ...
            mobilehtml += '<h6 class="text-color-delta"><?php echo e($staticContent['Launch_Date']); ?></h6>';
            mobilehtml += '<p class="text-one">'+formatedate(pro_launch['monthdate']) +'</p>';
            mobilehtml += '<h6 class="text-color-delta"><?php echo e($staticContent['Op_Power']); ?></h6>';
            mobilehtml += '<p class="text-one">'+pro_launch['op_wattage'] +'</p>';
            mobilehtml += '</div>';
            mobilehtml += '<div class="col-6">';
            mobilehtml += '<h6 class="text-color-delta"><?php echo e($staticContent['Op_Voltage']); ?></h6>';
            ...
            mobilehtml += '</div>';
            mobilehtml +=  '<a href="<?php echo e(config('app.url')); ?>/medias/marketing_resources/'+pro_launch['file']+'" download >';
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/product-launch-schedule.blade.php ENDPATH**/ ?>