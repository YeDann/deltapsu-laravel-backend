                ...
                <div class="row">
                        ...
                        <div class="block block-rounded block-bordered">
                            ...
                            <div class="block-content tab-content">
                                ...
                                <div class="tab-pane <?php echo e(($loop->iteration == 1)?'active':''); ?>"
                                    id="btabs-alt-static-<?php echo e($item2->name); ?>" role="tabpanel">
                                    <div class="form-group">
                                        <label for="example-select">Product Code <span class="req-fed">*</span></label>
                                        <input type="text"
                                            class="form-control <?php echo e($errors->has('name') ? 'is-invalid' : ''); ?>"
                                            name="productCode[<?php echo e($item2->name); ?>]"
                                            value="<?php echo e(isset($current->product_code)? $current->product_code :''); ?>"
                                            placeholder="Enter name...">
                                    </div>

                                    <div class="form-group">
                                        <label for="">Content</label>
                                        <textarea name="content[<?php echo e($item2->name); ?>]"
                                            class="jsnotenew"><?php echo e(isset($current->description)? $current->description :''); ?></textarea>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text"
                                class="form-control <?php echo e($errors->has('unitwWeight') ? 'is-invalid' : ''); ?>"
                        ...
                        <div class="form-group">
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-1" name="max_slot" value="1"
                                    required <?php echo e(($cproducts[0]->max_slot == 1) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-2" name="max_slot" value="2"
                                    required <?php echo e(($cproducts[0]->max_slot == 2) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-3" name="max_slot" value="3"
                                    required <?php echo e(($cproducts[0]->max_slot == 3) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-4" name="max_slot" value="4"
                                    required <?php echo e(($cproducts[0]->max_slot == 4) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-5" name="max_slot" value="5"
                                    required <?php echo e(($cproducts[0]->max_slot == 5) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-6" name="max_slot" value="6"
                                    required <?php echo e(($cproducts[0]->max_slot == 6) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-7" name="max_slot" value="7"
                                    required <?php echo e(($cproducts[0]->max_slot == 7) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-8" name="max_slot" value="8"
                                    required <?php echo e(($cproducts[0]->max_slot == 8) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-9" name="max_slot" value="9"
                                    required <?php echo e(($cproducts[0]->max_slot == 9) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-10" name="max_slot"
                                    value="10" required <?php echo e(($cproducts[0]->max_slot == 10) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-11" name="max_slot"
                                    value="11" required <?php echo e(($cproducts[0]->max_slot == 11) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-12" name="max_slot"
                                    value="12" required <?php echo e(($cproducts[0]->max_slot == 12) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-13" name="max_slot"
                                    value="13" required <?php echo e(($cproducts[0]->max_slot == 13) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-14" name="max_slot"
                                    value="14" required <?php echo e(($cproducts[0]->max_slot == 14) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status-15" name="max_slot"
                                    value="15" required <?php echo e(($cproducts[0]->max_slot == 15) ? 'checked':''); ?>>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status_1" name="status" value="1"
                                    <?php echo e(($cproducts[0]->status == 1) ? 'checked':''); ?>>
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                <input type="radio" class="custom-control-input" id="status_2" name="status" value="0"
                                    <?php echo e(($cproducts[0]->status == 0) ? 'checked':''); ?>>
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <input type="hidden" name="oldfile[thumbnail]"
                                                value="<?php echo e($cproducts[0]->thumb_img); ?>">
                                        </td>
                                        <td class="font-w600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <input type="hidden" name="oldfile[certificate]"
                                                value="<?php echo e($cproducts[0]->certificate_img); ?>">
                                        </td>
                                        <td class="font-w600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="">
                                            ...
                                            <input type="hidden" name="oldfile[preview]"
                                                value="<?php echo e($cproducts[0]->preview_img); ?>">
                                        </td>
                                        <td class="font-w600">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/configurableProduct/edit.blade.php ENDPATH**/ ?>