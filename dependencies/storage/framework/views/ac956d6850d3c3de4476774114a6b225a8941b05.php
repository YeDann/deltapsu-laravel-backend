        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#"><?php echo e($staticContent['catalogs']); ?></a></li>
                </ol>
            </nav>
        </div>
    </div>
                ...
                <div class="tab-content" id="nav-tabContent">
                    ...
                    <div class="tab-pane fade <?php echo e($loop->iteration == 1?'show active':''); ?> " id="pop<?php echo e($cate->cate_id); ?>" role="tabpanel" aria-labelledby="pop<?php echo e($cate->cate_id); ?>-tab">
                        ...
                        <div class="resources-download">
                            ...
                            <a href="<?php echo e(route('marketingLink',$marget->file)); ?>" target="_blank"  >
...
<script>
      ...
      function searchmarketingbycate(){
        ...
        $.each(resultsearch, function(index,value){
            ...
            html += '<p><?php echo e($staticContent['Uploaded_on']); ?> '+ setformatdate(value['created_at'])+' </p>';
            html += '</div>';
            html += '<a href="<?php echo e(config('app.url')); ?>/medias/marketing_resources/'+value['file']+'"  download="" >';
            html += '<button class="btn-downlode"><?php echo e($staticContent['Downloads']); ?></button>';
            html += '</a>';
            html += '</div>'
        });
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/catalog.blade.php ENDPATH**/ ?>