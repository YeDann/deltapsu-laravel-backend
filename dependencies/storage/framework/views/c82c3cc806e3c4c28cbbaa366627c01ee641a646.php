...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Edit  <?php echo e($type_name); ?></h1>
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                <li class="breadcrumb-item"> <a href="<?php echo e(route('partner_doc_index' ,[$type_id ,$type_name])); ?>">Edit <?php echo e($type_name); ?></a></li>
...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            <form action="<?php echo e(route('updatesaleKit')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>

                <div class="row">
                    <div class="col-lg-12">
                    <input type="hidden" name="update_id"  value="<?php echo e($sales_kits[0]->id); ?>">
                    ...
                    <input type="hidden" name="typeName" id="typeName" value="<?php echo e($type_name); ?>">
                            ...
                            <div class="tab-pane <?php echo e(($loop->iteration == 1)?"active":""); ?>" id="btabs-alt-static-<?php echo e($item->name); ?>" role="tabpanel">
                                    <div class="form-group">
                                     <label for="example-select"><span class="req-fed">*</span>Name</label>
                                        <input type="text" class="form-control" name="name[<?php echo e($item->name); ?>]" placeholder="Enter Text..." value="<?php echo e(isset($current->name)?$current->name :''); ?>" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="custom-file " style="width:100%;">
                                            <input type="file" class="custom-file-input" name="filesale[<?php echo e($item->name); ?>]"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="js-datepicker form-control <?php echo e($errors->has('date') ? 'is-invalid' : ''); ?>"  data-week-start="1" data-autoclose="true"
                                data-today-highlight="true" data-date-format="yyyy-mm-dd" value="<?php echo e($sales_kits[0]->date_info); ?>" placeholder="yyyy-mm-dd" name="date" required>
                        </div>
                    </div>
                    <div class="col-lg-12">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/partners/sale_kits_edit.blade.php ENDPATH**/ ?>