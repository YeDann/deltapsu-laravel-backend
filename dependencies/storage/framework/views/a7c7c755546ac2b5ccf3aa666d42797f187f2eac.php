                        ...
                        <div class="layout one-col fixed-width"
                            ...
                            <div class="layout__inner"  style="border-collapse: collapse;display: table;width: 100%;background-color: #ffffff;" emb-background-style>
                                ...
                                <div class="column"
                                    ...
                                    <p style="">
                                        Email : <?php echo e($contactForm['email']); ?>

                                    </p>
                                    <p style="">
                                        Link page : <a href="<?php echo e(config('app.url')); ?>/changePassword/<?php echo e($pin); ?>">Click here</a>
                                    </p>
                                    <p style="">
                                        Pin : <?php echo e($pin); ?>
                                    ...
                                    <p style="">
                                     ...
                                     <p style="">
                                        3. Click "Forgot Password?" to make a new request to change your password from this browser instead.
                                      </p>
                                </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/mail/forgetpass.blade.php ENDPATH**/ ?>