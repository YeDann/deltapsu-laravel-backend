    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="<?php echo e(route('contactzoneCreate',$type)); ?>" class="btn btn-success">Create <i class="fa fa-plus"></i></a>
                </div>
            </div>
        </div>
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="d-none d-sm-table-cell text-center"><a href="<?php echo e(route('sell-office.show',$item->contact_zone_id)); ?>" class="btn btn-info col-md-8">Sale Office</a></td>
                    <td class="font-w600"><?php echo e($item->created_at); ?></td>
                    <td class="text-center">
                        <div class="btn-group">
                            <button class="btn btn-secondary btn-sm"  
                                data-target="#modal-block-popin-2"  data-toggle="modal" onclick="sendId(<?php echo e($item->contact_zone_id); ?>)" >Duplicate <i class="far fa-clone"></i> </button>
                                <a href="<?php echo e(route('contactzoneEdit',['id' =>$item->contact_zone_id,'type'=>$type ])); ?>" class="btn btn-primary btn-sm">Edit <i
                                    class="fa fa-pencil-alt"></i> </a>
                            <button type="button" class="btn btn-sm btn-danger" data-toggle="tooltip" id="delbutton"
                                title="Delete" onclick="deleteIndex(<?php echo e($item->contact_zone_id); ?>)">
        ...
        <div class="modal-dialog modal-dialog-popin" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mt-0">
                    ...
                    <form action="<?php echo e(route('copyZone')); ?>" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-dialog modal-dialog-popin" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mt-0">
                    ...
                    <form action="<?php echo e(route('copyZonesingle')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo e(csrf_field()); ?>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "<?php echo e((route('destroyZone'))); ?>/" + id;
                });
            }
        });
    }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/contact-zone/index.blade.php ENDPATH**/ ?>