        ...
        <div class="row add-space-mobile">
            <div class="col-xl-4  col-md-12">
                <div class="d-flex mb-4">
                    <img class="img-fluid m-auto w-100" src="<?php echo e(asset('frontend-asset/image/Configurable-Power750.png')); ?>" alt="">
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/Configure-detail.blade.php ENDPATH**/ ?>