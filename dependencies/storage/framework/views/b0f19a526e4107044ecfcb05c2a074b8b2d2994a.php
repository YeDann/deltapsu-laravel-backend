...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('/frontend-asset/css/result-page.css')); ?>" media="screen">
    ...
    <!-- Fonts -->
    <!-- Styles -->
    <script type="text/javascript" src="<?php echo e(asset('/frontend-asset/js/jquery-3.4.1.min.js')); ?>"></script>
