...
<head>
    ...
    <!-- Bootstrap CSS -->
    <link rel="stylesheet" href="<?php echo e(asset('/frontend-asset/css/bootstrap.min.css')); ?>"  media="screen"/>
    ...
    <link href="<?php echo e(asset('/frontend-asset/css/nouislider.min.css')); ?>" rel="stylesheet" media="screen"/>
    ...
    <!-- Fonts -->
    <!-- Styles -->
    <script src="<?php echo e(asset('/frontend-asset/js/jquery-3.4.1.min.js')); ?>"></script>
...
<script src="<?php echo e(asset('/frontend-asset/js/nouislider.min.js')); ?>"></script>
    ...
    <script>
      ...
      <script>
        ...
        function showNavCoparison(id ,cateid){
          ...
          $.ajax({
           url: "<?php echo e(route('checkProductSection')); ?>",
           data: {
          'data': id,
          'cateid':cateid,
           },
        ...
        function deleteComparison(id){
          $.ajax({
           url: "<?php echo e(route('RemovedataInSection')); ?>",
           data: {
          'data': id,
           },
           type: 'POST',
        ...
        function bigImg(image ,id){
           if(image != ''){
            $('.imageNav'+id).attr('src' ,'<?php echo e(config('app.url')); ?>/medias/categories/'+image);
           }else {
            $('.imageNav'+id).attr('src' ,'<?php echo e(asset('frontend-asset/image/blank.png')); ?>');
         
           }
        }
        function mainCate(id){
          if(id == 'sub1'){
            $('.imageNav2').attr('src' ,"<?php echo e(asset('frontend-asset/image/Industrial_Power_Supplies.png')); ?>");
          }else if(id == 'sub2'){
            $('.imageNav1').attr('src' ,"<?php echo e(asset('frontend-asset/image/Medical-Power-Supplies.png')); ?>");
          }
        ...
        function setlocaltion(lang ,link){
          // console.log(lang);
          $.ajax({
           url: "<?php echo e(route('setlocaltion')); ?>",
           data: {
          'lang': lang,
           },
           type: 'POST',
       ...
       <script>
         $( "#formseachall" ).submit(function( event ) {
            ...
            //  console.log();
              event.preventDefault();
              window.location = '<?php echo e(route('searchAll')); ?>/'+newkey;
         });
      ...
      <script>
        ...
        <?php if(Session::has('subscribes_already')): ?>
        $(document).ready(function() {
             $("#success_subscribe_already").modal();
          });
        <?php endif; ?>

        <?php if(Session::has('subscribes_new')): ?>
        $(document).ready(function() {
...
</html><?php /**PATH C:\xampp\htdocs\Deltapsu_Production\dependencies\resources\views/layouts/front-end.blade.php ENDPATH**/ ?>