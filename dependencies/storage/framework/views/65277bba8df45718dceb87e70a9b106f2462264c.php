                ...
                <div class="col-lg-3">
                    <a href="<?php echo e(route('applicationDetail' ,[ 'name' => preg_replace('/\s+/', '-',$app->applica_id.'-'.$app->name)])); ?>" class="other-applications-list media">
                        ...
                        <div class="h-text-app">
                            <h6 class="text-title-dark"><?php echo e($app->name); ?> </h6>
                        </div>
                        </div>
             ...
             <div  class="row">
                ...
                <div class="col-md-6">
                    <a href="<?php echo e(route('applicationDetail' ,[ 'name' => preg_replace('/\s+/', '-',$app->applica_id.'-'.$app->name)])); ?>" class="other-applications-grid-mobile-list">
                        ...
                        <h6 class="text-title-dark text-center"><?php echo e($app->name); ?></h6>
                    </a>
                </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/applicationdetail.blade.php ENDPATH**/ ?>