...
<script type="text/javascript">
    ...
    function onclickListView(productarray ,type ,id) {
        ...
        html1 += '<th id="sortdata2" class=" header-font-table w-tabfix w-120"  onclick="selectTable(2)"><?php echo e($staticContent['Output_Voltage']); ?></th>';
        html1 += '<th id="sortdata3" class=" header-font-table w-tabfix w-120"  onclick="selectTable(3)"><?php echo e($staticContent['Output_Current']); ?></th>';
        html1 += '<th id="sortdata4" class=" header-font-table w-tabfix w-120"  onclick="selectTable(4)"><?php echo e($staticContent['Output_Power']); ?> </th>';
