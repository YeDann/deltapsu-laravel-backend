...
<script type="text/javascript">
    ...
    function onclickGridView(productarray) {
        ...
        html1 += '<div class="boxlist-icon-img pd-mobile">';
    ...
    function onclickListView(productarray ,type ,id) {
        ...
        html1 += '<th  id="sortdata1" class=" header-font-table w-tabfix"  onclick="selectTable(1)"><?php echo e($staticContent['Model_Name']); ?></th>';
