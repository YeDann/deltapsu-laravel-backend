...
<div class="box-deltapsu mb-5">
    <div class="container">
        ...
        <img class="col-12  visible-up-922" src="<?php echo e(asset('/frontend-asset/image/banner-delta-rd_201508101439180101987642@2x.png')); ?>" alt="">
        ...
        <img class="col-12  invisible-up-922 mt-4" src="<?php echo e(asset('/frontend-asset/image/banner-delta-rd_mobile@2x.png')); ?>" alt="">    
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/about-delta-rd.blade.php ENDPATH**/ ?>