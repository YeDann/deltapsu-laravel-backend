                ...
                <tbody>
                   ...
                   <tr class="odd order-list" data-id="<?php echo e($item->id); ?>">
                    ...
                    <td class="text-center">
                        <a href="<?php echo e(route('editFilterSelector' ,$item->id)); ?>" class="btn btn-outline-info">Edit</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/product/default_filter.blade.php ENDPATH**/ ?>