                                                    ...
                                                    <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                        ...
                                                        <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                            ...
                                                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                ...
                                                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                    <input type="radio" class="custom-control-input" id="status-7" name="max_slot" value="7" required <?php echo e(($cproducts[0]->max_slot == 7) ? 'checked':''); ?>>
                                                                    <label class="custom-control-label" for="status-7">7</label>
                                                                </div>
                                                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                        <input type="radio" class="custom-control-input" id="status-8" name="max_slot" value="8" required <?php echo e(($cproducts[0]->max_slot == 8) ? 'checked':''); ?>>
                                                                        <label class="custom-control-label" for="status-8">8</label>
                                                                    </div>
                                                                    <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                            <input type="radio" class="custom-control-input" id="status-9" name="max_slot" value="9"  required <?php echo e(($cproducts[0]->max_slot == 9) ? 'checked':''); ?>>
                                                                            <label class="custom-control-label" for="status-9">9</label>
                                                                        </div>
                                                                        <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                                <input type="radio" class="custom-control-input" id="status-10" name="max_slot" value="10" required <?php echo e(($cproducts[0]->max_slot == 10) ? 'checked':''); ?>>
                                                                                <label class="custom-control-label" for="status-10">10</label>
                                                                            </div>
                                                                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                                    <input type="radio" class="custom-control-input" id="status-11" name="max_slot" value="11" required <?php echo e(($cproducts[0]->max_slot == 11) ? 'checked':''); ?>>
                                                                                    <label class="custom-control-label" for="status-11">11</label>
                                                                                </div>
                                                                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                                    <input type="radio" class="custom-control-input" id="status-12" name="max_slot" value="12" required <?php echo e(($cproducts[0]->max_slot == 12) ? 'checked':''); ?>>
                                                                                    <label class="custom-control-label" for="status-12">12</label>
                                                                                </div>
                                                                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                                    <input type="radio" class="custom-control-input" id="status-13" name="max_slot" value="13" required <?php echo e(($cproducts[0]->max_slot == 13) ? 'checked':''); ?>>
                                                                                    <label class="custom-control-label" for="status-13">13</label>
                                                                                </div>
                                                                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                                    <input type="radio" class="custom-control-input" id="status-14" name="max_slot" value="14" required <?php echo e(($cproducts[0]->max_slot == 14) ? 'checked':''); ?>>
                                                                                    <label class="custom-control-label" for="status-14">14</label>
                                                                                </div>
                                                                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                                                                    <input type="radio" class="custom-control-input" id="status-15" name="max_slot" value="15" required <?php echo e(($cproducts[0]->max_slot == 15) ? 'checked':''); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Deltapsu_Production\dependencies\resources\views/configurableProduct/edit.blade.php ENDPATH**/ ?>