            ...
            <div class="nav-link-list d-flex">
                ...
                <div class="col-nav d-flex justify-content-end">
                    ...
                    <select name="" id="select-mobile-lang" onchange="changeLangLocationmobile();" class="select-language text-uppercase">
                      ...
                      <option  value="<?php echo e(LaravelLocalization::getLocalizedURL($current, null, [], true)); ?>" <?php echo e(App::getLocale() == $current?'selected':''); ?>>
                        <?php if($current == 'cn'): ?>
                            简中
                        <?php elseif($current == 'tw'): ?>
                            繁中
...
<div id="modalCompareSection" class="modal" tabindex="-1" role="dialog" style="display:none;">
      ...
      <div class="modal-content ">
        ...
        <div class="modal-body px-4 mb-4">
          ...
          <div class="input-label w-100 my-4">
            ...
            <input type="text" class="form-control" name="company_gui"  pattern="[A-Za-zก-๏\s().]+"  placeholder="<?php echo e($staticContent['Company']); ?>" required>
          </div>
          <div class="input-label w-100 my-4">
  ...
  <div class="modal fade p-1" id="Support_Frorm_required" tabindex="-1" role="dialog" aria-labelledby="subscribe-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content ">
        <div class="modal-header pl-4">
          <h4 class="text-color-delta mb-0" id="subscribe-modal-title2">Eror Message</h4>
  ...
  <div class="modal fade p-1" id="Support_policy_required" tabindex="-1" role="dialog" aria-labelledby="subscribe-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content ">
        <div class="modal-header pl-4">
          <h4 class="text-color-delta mb-0" id="subscribe-modal-title2">Eror Message</h4>
  ...
  <div class="modal fade p-1" id="notfound_product" tabindex="-1" role="dialog" aria-labelledby="subscribe-modal-title" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
      <div class="modal-content ">
        <div class="modal-header pl-4">
          <h4 class="text-color-delta mb-0" id="subscribe-modal-title2">Message</h4>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/layouts/header-front.blade.php ENDPATH**/ ?>