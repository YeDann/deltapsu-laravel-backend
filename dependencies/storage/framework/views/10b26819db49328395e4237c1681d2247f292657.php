                ...
                <div class="col-lg-6 col-md-12  select input-label w-100 mb-4">
                    ...
                    <select name="country"  class="form-control required" onchange="selectCountry();" id="countryemailId"  required>
                        ...
                        <?php $__currentLoopData = $countryemails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $email): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <option value="<?php echo e($email->country); ?>" <?php echo e($email->country == 'China'?'selected':''); ?>><?php echo e($email->country); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div> 
                <div class="col-lg-6 col-md-12 input-label w-100 mb-4">
                    <label class="text-title-detail-dark"><?php echo e($staticContent['Model']); ?></label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Deltapsu_Production\dependencies\resources\views/front-end/support.blade.php ENDPATH**/ ?>