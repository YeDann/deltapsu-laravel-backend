...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Continents</h1>
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="<?php echo e(route('createContinent' ,$type_id)); ?>" class="btn btn-success">Create</a>
        ...
        <div class="block-content block-content-full">
            ...
            <table class="table table-bordered table-striped table-vcenter ">
                ...
                <tbody>
                    <?php if(isset($continents) and !empty($continents)): ?>
                    ...
                    <td class="text-center">
                            <a href="<?php echo e(route('getOffices' ,[$item->id ,$type_id])); ?>" class="btn btn-outline-info">
                                <?php if($type_id == 1): ?>
                                Sales Offices
                                <?php else: ?> 
                                Distributors
                            ...
                            <a href="<?php echo e(route('editContinent' ,[$item->id ,$type_id])); ?>" class="btn btn-primary">Edit</a>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="block block-themed block-transparent mb-0">
                    ...
                    <form action="<?php echo e(route('deleteContinent')); ?>" method="POST" >
...
<script>
    ...
    $('tbody').sortable({
        ...
        stop: function (event, ui) {
            ...
            $.ajax({
                url: "<?php echo e(route('update_order_Continent')); ?>",
                type: 'post',
                data: formData,
                headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/continents/index.blade.php ENDPATH**/ ?>