            ...
            <div class="row">
                ...
                <div class="col-8">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 box-product-detail">
                            <h5 class="text-color-delta mb-2"> <?php echo e($staticContent['Dimensions']); ?> (L x W x <?php echo e($product[0]['unit_dimension']); ?>) </h5>
                        ...
                        <div class="col-sm-4 box-product-detail">
                            ...
                            ?>
                            <p class="text-one"><?php echo e($product[0]['unit_weight']); ?> (<?php echo e(number_format($sum,2)); ?> lb)</p>
            ...
            <div>
                ...
                ?>
                    ...
                    <div class="data-sheet-downloade d-flex justify-content-between ">
                        ...
                        <a data-toggle="modal" data-target="#downloadgui-modal" onclick="downloadGUI('<?php echo e($item->file); ?>','<?php echo e(setTextpro($product[0]['pro_code'])); ?>')" href="<?php echo e(route('downloadFIle',[$item->slug,setTextpro($product[0]['pro_code'])])); ?>" target="_blank">
                        <button class="btn-downlode"><?php echo e($staticContent['Downloads']); ?></button>
                        </a>
                    </div>
                    <?php endif; ?>
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            <td >
                                ...
                                <div class="col-md-9 explain-detail ">
                                    <?php echo e($product[0]['unit_weight']); ?> (<?php echo e(number_format($sum,2)); ?> lb)
                                </div>
                            </td>
                            <td >
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Deltapsu_Production\dependencies\resources\views/front-end/productdetails.blade.php ENDPATH**/ ?>