        ...
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    ...
                    <a href="<?php echo e(route('createSeries' ,0)); ?>" class="btn btn-success">Create</a>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                <thead>
                    <tr>
                        ...
                        <th class="d-none d-sm-table-cell" style="width: 10%;">Slug</th>
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <div class="">
                                <a href="<?php echo e(route('editSeries' ,['id'=>$item->se_id ,'cateId'=>0 ])); ?>" class="btn btn-primary">Edit</a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/pro_categories/series_all.blade.php ENDPATH**/ ?>