        ...
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="<?php echo e(route('event.create')); ?>" class="btn btn-success"><i class="fa fa-plus"></i> Create </a>
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <div class="">
                                    ...
                                    <a href="<?php echo e(route('event.edit',$item->id)); ?>" class="btn btn-primary btn-sm">Edit </a>
    ...
    <div class="modal-dialog modal-dialog-popin" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mt-0">
                ...
                <form action="<?php echo e(route('copyEvent')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-dialog-popin" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mt-0">
                ...
                <form action="<?php echo e(route('copyEventsingle')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "<?php echo e((route('destroyEvent'))); ?>/" + id;
                });
            }
        });
    }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/event/index.blade.php ENDPATH**/ ?>