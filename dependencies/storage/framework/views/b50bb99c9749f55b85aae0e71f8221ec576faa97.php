...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Banner Slide</h1>
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                <a href="<?php echo e(route('bannerSlide.create')); ?>" class="btn btn-success">Create</a>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="text-center">
                            <a href="<?php echo e(route('editBanner' ,$item->id)); ?>" class="btn btn-primary">Edit</a>
...
<script>
        ...
        $('tbody').sortable({
            ...
            stop: function (event, ui) {
                ...
                $.ajax({
                    url: "<?php echo e(route('update_order_Banner')); ?>",
                    type: 'post',
                    data: formData,
                    headers: {
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/banner/index.blade.php ENDPATH**/ ?>