...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            <form action="<?php echo e(route('section.store')); ?>" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="tab-pane active" id="btabs-alt-static-<?php echo e($item->name); ?>" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="name[<?php echo e($item->name); ?>]" placeholder="Section name...">
                                    </div>
                                </div>
                                <?php else: ?>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/section/create.blade.php ENDPATH**/ ?>