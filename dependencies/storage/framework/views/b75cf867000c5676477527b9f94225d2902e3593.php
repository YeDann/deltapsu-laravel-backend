    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                ...
                <div class="block-options-item">
                    <a href="<?php echo e(route('product-field.create')); ?>" class="btn btn-success">Create</a>
                </div>
            </div>
        </div>
        <div class="block-content block-content-full">
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    <?php if(isset($pd_field) and !empty($pd_field)): ?>
                    ...
                    <td class="d-none d-sm-table-cell"><?php echo e($item->field_name); ?></td>
                    <td class="d-none d-sm-table-cell"><?php echo e($item->type); ?></td>
                    <td class="d-none d-sm-table-cell"><?php echo e($item->section_name); ?></td>
                    <td class="font-w600"><?php echo e($item->created_at); ?></td>
                    <td class="text-center">
                        <div class="">
                            
                            <a href="<?php echo e(route('product-field.edit',$item->pd_field_id)); ?>"
                                class="btn btn-primary">Edit </a>
                            <button type="button" class="btn btn-danger" data-toggle="tooltip" id="delbutton"
                                title="Delete" onclick="deleteProductfield(<?php echo e($item->pd_field_id); ?>)">
                                Delete 
                            </button>
                        </div>
                    </td>
    ...
    <div class="modal-dialog modal-dialog-popin" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <form action="<?php echo e(route('copyProductField')); ?>" method="POST" enctype="multipart/form-data">
    ...
    <div class="modal-dialog modal-dialog-popin" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                ...
                <form action="<?php echo e(route('copyProductFieldsingle')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo e(csrf_field()); ?>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "<?php echo e((route('productfieldDestroy'))); ?>/" + id;
                });
            }
        });
    }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/product-field/index.blade.php ENDPATH**/ ?>