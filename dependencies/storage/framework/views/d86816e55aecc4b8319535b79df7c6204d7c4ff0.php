...
<script>
        ...
        function getContentByModel(method){
            ...
            $.each(documents, function(index,doc){  
                ...
                html2 += '<button class="btn-downlode" data-toggle="modal" data-target="#downloadgui-modal" onclick="downloadGUI('+"'"+ doc['file']+"'"+','+"'"+procode+"'"+')"><?php echo e($staticContent['Downloads']); ?></button>';
                html2 += ' </div>' ;
                 }
                }
                });  
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Deltapsu_Production\dependencies\resources\views\front-end\product-documents.blade.php ENDPATH**/ ?>