                ...
                <div class="row push">
                    ...
                    <div class="col-lg-8 col-xl-5">
                        ...
                        <div class="block block-rounded block-bordered">
                            ...
                            <input type="text" class="form-control" name="order_seq" value="<?php echo e($contents[0]->order_seq); ?>" placeholder="Number" >
                             </div>
                        <div class="form-group">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/news-type/edit.blade.php ENDPATH**/ ?>