                                                    ...
                                                    <tbody>
                                                      <?php if(isset($ticket_id)): ?>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo e($contactForm['tel']); ?></td>
                                                        </tr>
                                                        <?php endif; ?>
                                                        <tr>
                                                        ...
                                                        <?php if(isset($contactForm['company'])): ?>
                                                        <tr>
                                                            <td style="width: 180px;">Company : </td>
                                                            <td><?php echo e($contactForm['company']); ?></td>
                                                        </tr>
                                                        <?php endif; ?>
                                                     
                                                        <tr>
                                                            <td style="width: 180px;">Country : </td>
                                                            <td> <?php echo e(isset($contactForm['country']) ? $contactForm['country'] :'-'); ?></td>
                                                        </tr>

                                                        <tr>
                                                            <td style="width: 180px;">City / State : </td>

                                                            <td> <?php echo e(isset($contactForm['state']) ? $contactForm['state'] :'-'); ?></td>
                                                        </tr>

                                                        <tr>
                                                            <td style="width: 180px;">Product Type : </td>
                                                            <td><?php echo e($contactForm['type_name']); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td style="width: 180px;">Model : </td>
                                                            <td><?php echo e(isset($contactForm['model_name']) ? $contactForm['model_name'] :'-'); ?></td>
                                                        </tr>
                                                    
                                                        <tr>
                                                            <td style="width: 180px;color:#007bff;">Sign up for newsletter : </td>
                                                            <td><?php echo e(isset($contactForm['checkData']) && $contactForm['checkData'] == 1 ?'Yes':'No'); ?></td>
                                                        </tr>
                                                       
                                                </table>
                                                <div style="max-width:600px;color: #444444;font-size: 16px;">
                                                    Message : 
                                                    <span style="color: #444444;font-size: 14px;">
                                                        <?php echo e(isset($contactForm['message']) ? $contactForm['message'] :'-'); ?>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/mail/contactUs.blade.php ENDPATH**/ ?>