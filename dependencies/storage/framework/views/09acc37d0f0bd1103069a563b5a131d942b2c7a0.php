                                    ...
                                    <div style="Margin-left: 20px;Margin-right: 20px;">
                                        <div style="mso-line-height-rule: exactly;mso-text-raise: 4px;">
                                            <p style="Margin-top: 0;Margin-bottom: 20px;">
                                                <table>
                                                    <tbody>
                                                        <?php if(isset($contactForm['procodeGui'])): ?>
                                                        <tr>
                                                            <td style="width: 100px;">Model :</td>
                                                            <td><?php echo e($contactForm['procodeGui']); ?></td>
                                                        </tr>
                                                        <?php endif; ?>
                                                        <?php if(isset($contactForm['name_gui'])): ?>
                                                        <tr>
                                                            <td style="width: 100px;">Name :</td>
                                                            <td><?php echo e($contactForm['name_gui']); ?></td>
                                                        </tr>
                                                        <?php endif; ?>
                                                        <tr>
                                                            <td style="width: 100px;">Email : </td>
                                                            <td><?php echo e($contactForm['email_gui']); ?></td>
                                                        </tr>


                                                        <?php if(isset($contactForm['company_gui'])): ?>
                                                        <tr>
                                                            <td style="width: 100px;">Company : </td>
                                                            <td><?php echo e($contactForm['company_gui']); ?></td>
                                                        </tr>
                                                        <?php endif; ?>
                                                        <?php if(isset($contactForm['country'])): ?>
                                                        <tr>
                                                            <td style="width: 100px;">Country : </td>
                                                            <td><?php echo e($contactForm['country']); ?></td>
                                                        </tr>
                                                        <?php endif; ?>
                                                        ...
                                                        <?php if(isset($contactForm['checkData'])): ?>
                                                        <tr>
                                                            <td style="width: 150px;">Signup newsletter : </td>
                                                            <td><?php echo e(isset($contactForm['checkData']) && $contactForm['checkData'] == 1 ?'Yes':'No'); ?>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/mail/Guidownload.blade.php ENDPATH**/ ?>