            ...
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#"><?php echo e($staticContent['edit']); ?></a></li>
                    </ol>
                </ol>
            </nav>
        </div>
...
<div class="mb-5">
    ...
    <div class="container">
        <form id="form-success-story" action="<?php echo e(route('updateSuccessStories')); ?>" method="POST" enctype="multipart/form-data">
            <?php echo e(csrf_field()); ?>

        <h2 class="text-title-delta visible-up-922"><?php echo e($staticContent['edit']); ?> <?php echo e($staticContent['Success_Stories']); ?></h2>
        <h3 class="text-title-delta invisible-up-922"><?php echo e($staticContent['edit']); ?> <?php echo e($staticContent['Success_Stories']); ?></h3>
        <div class="row">
            <input type="hidden" id="story_id_top" name="story_id_main" value="<?php echo e($AllsuccessStory[0]->id); ?>">
            ...
            <input type="text" onkeyup="keycheck();" class="form-control" name="application"  id="application" placeholder="Enter application "  value="<?php echo e($AllsuccessStory[0]->application); ?>">
            </div>
        </div>
        <div class="row  ">
            <div class="col-lg-6 col-md-12 input-label w-100 mb-4">
                <label class="text-title-detail-dark"><?php echo e($staticContent['End_Customer']); ?><span class="red">*</span></label>
                <input type="text" onkeyup="keycheck();" class="form-control" name="endCustomer"   id="endCustomer" placeholder="<?php echo e($staticContent['End_Customer']); ?>"  value="<?php echo e($AllsuccessStory[0]->endCustomer); ?>"> 
        ...
        <div class="row">
            <div class="col-12">
                ...
                <div class="input-label">
                    <textarea name="message" onkeyup="keycheck();" id="message" class="w-100 text-area"  placeholder="<?php echo e($staticContent['Message']); ?>" rows="10" style="padding: .75rem;" ><?php echo e($AllsuccessStory[0]->message); ?></textarea>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-12">
                <label class="text-title-detail-dark"><?php echo e($staticContent['Old_Image']); ?><span class="red">*</span></label>
            </div>
        </div>
        <div class="row mb-4">
            <?php $__currentLoopData = $image_story; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="col-2"  id="oldimg<?php echo e($item->id); ?>">
               <img  class="w-100"   src="<?php echo e(config('app.url')); ?>/medias/marketing_resources/<?php echo e($item->image); ?>">
               <button class="delete_img" type="button" onclick="deleteImage(<?php echo e($item->id); ?>)">X</button>
            </div>
        ...
        <div class="row">
            ...
            <input type="hidden" name="story_id"  id="story_id" value="<?php echo e($AllsuccessStory[0]->id); ?>">
                </form>
            </div>
        </div>
        <div class="row">
            <div class="col-lg-12 text-center">
            <p><?php echo e($staticContent['By_submitting_this_form']); ?> <a target="_blank" class="text-a-link" href="<?php echo e(route('privacyPolicy')); ?>"><?php echo e($staticContent['Privacy_Policy']); ?></a>.</p>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
            <div class="btn btn-boxen" onclick="closedeleteImage();"><?php echo e($staticContent['Cancel']); ?></div>
         <div class="btn btn-subscribe" onclick="onconfirmdeleteImage();"><?php echo e($staticContent['Delete']); ?></div>
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
         ...
         <div class="btn btn-subscribe" onclick="onsubmitContent();"><?php echo e($staticContent['Submit']); ?></div>
...
<script>
   ...
   function onconfirmdeleteImage(){
        var id = $('#imgid').val();
        $.ajax({
           url: "<?php echo e(route('deleteImageSucess')); ?>",
           data: {
          'img_id': id,
           },
           type: 'POST',
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/edit-success-stories.blade.php ENDPATH**/ ?>