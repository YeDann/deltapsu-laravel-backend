    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <a href="<?php echo e(route('application-view.index')); ?>">Application View</a>
                    </li>
...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            <form action="<?php echo e(route('applicationUpdate')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>

            <input  type="hidden" name="appId" value="<?php echo e($contents[0]->applica_id); ?>">
                <!-- Basic Elements -->
                <div class="row">
                    <div class="col-md-12">
                            ...
                            <div class="tab-pane <?php echo e($loop->iteration == 1 ?'active':''); ?>" id="btabs-alt-static-<?php echo e($item->name); ?>" role="tabpanel">
                                    <div class="form-group">
                                        ...
                                        <input type="text"
                                            ...
                                            name="name[<?php echo e($item->name); ?>]" value="<?php echo e(isset($current->name)?$current->name :''); ?>"
                                            placeholder="Enter name...">
                                    </div>
                                     <div class="form-group">
                                        <label for="">Overview</label>
                                        <textarea name="overview_text[<?php echo e($item->name); ?>]" rows="2" class=" form-control"><?php echo e(isset($current->overview_text)?$current->overview_text :''); ?></textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" name="overview[<?php echo e($item->name); ?>]"
                                            class=" form-control"><?php echo e(isset($current->overview)?$current->overview :''); ?> </textarea>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-1" name="status" value="1"  <?php echo e($contents[0]->status == 1 ?"checked":""); ?>>
                                    <label class="custom-control-label" for="status-1">Show</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-2" name="status" value="0" <?php echo e($contents[0]->status == 0 ?"checked":""); ?>>
                    ...
                    <div class="col-md-12">
                            ...
                            <table class="table table-bordered table-striped table-vcenter">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="<?php echo e(config('app.url')); ?>/medias/categories/<?php echo e($contents[0]->color_icon); ?>"
                                                class="img-thumbnail res-image" alt="">
                                                <input type="hidden" name="oldfile[color_icon]" value="<?php echo e($contents[0]->color_icon); ?>" >
                                        </td>
                                    ...
                                    <tr class="">
                                            ...
                                            <td class="text-center">
                                                    <img src="<?php echo e(config('app.url')); ?>/medias/categories/<?php echo e($contents[0]->blue_outline_icon); ?>"
                                                        class="img-thumbnail res-image" alt="">
                                                        <input type="hidden" name="oldfile[blue_outline_icon]" value="<?php echo e($contents[0]->blue_outline_icon); ?>" >
                                                </td>
                                            <td class="font-w600">
                                                <img src="https://via.placeholder.com/72x72.png"
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <img src="<?php echo e(config('app.url')); ?>/medias/categories/<?php echo e($contents[0]->icon); ?>"
                                                    class="img-thumbnail res-image" alt="">
                                            </td>
                                            <td class="font-w600">
                                                <img src="https://via.placeholder.com/72x72.png"
                                                    class="img-thumbnail imagePreview1 res-image" alt="">
                                                    <input type="hidden" name="oldfile[icon]" value="<?php echo e($contents[0]->icon); ?>" >
                                            </td>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="<?php echo e(config('app.url')); ?>/medias/categories/<?php echo e($contents[0]->thumbnail); ?>"
                                                class="img-thumbnail res-image" alt="">
                                                <input type="hidden" name="oldfile[thumbnail]" value="<?php echo e($contents[0]->thumbnail); ?>" >
                                        </td>
                                        <td class="font-w600">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="<?php echo e(config('app.url')); ?>/medias/categories/<?php echo e($contents[0]->banner); ?>"
                                                class="img-thumbnail res-image" alt="">
                                                <input type="hidden" name="oldfile[banner]" value="<?php echo e($contents[0]->banner); ?>" >
                                        </td>
                                        <td class="font-w600">
                        ...
                        <div class="form-group text-center">
                                ...
                                <a href="<?php echo e(route('application-view.index')); ?>" class="btn btn-secondary">
                                    Cancel
                                </a>
                            </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/application/edit.blade.php ENDPATH**/ ?>