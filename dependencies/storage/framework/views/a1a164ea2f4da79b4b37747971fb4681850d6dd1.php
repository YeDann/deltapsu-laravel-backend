    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <a href="<?php echo e(route('backendUser.index')); ?>" >Partner</a></li>
...
<div class="content mb-5">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content mb-5">
            <form id="submitformbkuser" method="POST" action="<?php echo e(route('updatepartner')); ?>">
                <?php echo csrf_field(); ?>
                <!-- Basic Elements -->
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12 col-xl-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="firstname" type="text" class="form-control<?php echo e($errors->has('firstname') ? ' is-invalid' : ''); ?>" name="firstname" value="<?php echo e($user->firstname); ?>" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="lastname" type="text" class="form-control<?php echo e($errors->has('lastname') ? ' is-invalid' : ''); ?>" name="lastname" value="<?php echo e($user->lastname); ?>" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="position" type="text" class="form-control<?php echo e($errors->has('position') ? ' is-invalid' : ''); ?>" name="position" value="<?php echo e($user->position); ?>" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="companyName" type="text" class="form-control<?php echo e($errors->has('companyName') ? ' is-invalid' : ''); ?>" name="companyName" value="<?php echo e($user->companyName); ?>" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="phone" type="text" class="form-control<?php echo e($errors->has('phone') ? ' is-invalid' : ''); ?>" name="phone" value="<?php echo e($user->phone); ?>" required >
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="fax" type="text" class="form-control<?php echo e($errors->has('fax') ? ' is-invalid' : ''); ?>" name="fax" value="<?php echo e($user->fax); ?>" required >
                        ...
                        *The password must be at least 8 characters.
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-1" name="role" value="1"  <?php echo e($user->role == 1 ?'checked':''); ?> >
                                    <label class="custom-control-label" for="status-1">Distributor</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-2" name="role" value="2"  <?php echo e($user->role == 2 ?'checked':''); ?> >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/user/editPartner.blade.php ENDPATH**/ ?>