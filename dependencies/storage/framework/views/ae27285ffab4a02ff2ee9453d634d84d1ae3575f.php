                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb-home dropdown" aria-current="page"><a
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo e(route('aboutUs',$abt->stug)); ?>" class="" ><?php echo e($abt->title); ?></a></li>
...
<div class="box-deltapsu">
    <div class="container">
        ...
        <div class="invisible-up-922 mb-5 mt-4">
            <a class="btn btn-subscribe w-100 mb-3" href="http://www.delta-americas.com/"><?php echo e($staticContent['America']); ?></a>
            <a class="btn btn-subscribe w-100 mb-3" href="http://www.deltaww.com/default.aspx?hl=zh-TW"><?php echo e($staticContent['Asia']); ?></a>
            <a class="btn btn-subscribe w-100 mb-3" href="http://www.delta-emea.com/default.aspx?hl=en-GB"><?php echo e($staticContent['Europe']); ?></a>
        </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/about-global.blade.php ENDPATH**/ ?>