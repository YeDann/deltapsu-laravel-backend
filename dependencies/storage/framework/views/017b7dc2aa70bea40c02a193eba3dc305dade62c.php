        ...
        <div class="block-content block-content-full">
            ...
            <table class="table table-bordered table-striped table-vcenter">
                ...
                <tbody>
                    ...
                    <tr class="odd order-list" data-id="<?php echo e($item->sub_pro_id); ?>">
                    <td class="text-center"><?php echo e($loop->iteration); ?></td>
                    <td class="d-none d-sm-table-cell"><?php echo e($item->name); ?></td>
                    <td class="text-center">
                        
                        <div class="custom-control custom-switch custom-control-lg mb-2">
                                <input type="checkbox" class="custom-control-input" id="statusCate<?php echo e($item->sub_pro_id); ?>" onchange="checkdata(<?php echo e($item->sub_pro_id); ?>);"  <?php echo e(($item->status== 1)?'checked':''); ?>>
                        <label class="custom-control-label" id="lablestatusCate<?php echo e($item->sub_pro_id); ?>" for="statusCate<?php echo e($item->sub_pro_id); ?>"><?php echo e($item->status == 1?'Show':'Hide'); ?></label>
                            </div>
                    </td>
                    </tr>
...
<script>
        ...
        $('tbody').sortable({
            ...
            stop: function (event, ui) {
                ...
                $.ajax({
                    url: "<?php echo e(route('update_order_productselect')); ?>",
                    type: 'post',
                    data: formData,
                    headers: {
...
<script>
    ...
    function checkdata(id){
        $.ajax({
                url: "<?php echo e((route('updateProSection'))); ?>/" + id,
                type: 'get',
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                },
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/product/productSection.blade.php ENDPATH**/ ?>