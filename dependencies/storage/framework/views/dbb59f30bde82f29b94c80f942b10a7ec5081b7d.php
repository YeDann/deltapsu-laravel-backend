    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item active" aria-current="page">Product News Type</li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title"><a href="<?php echo e(route('news.index')); ?>" class="btn btn-info" > <i class="fa fa-chevron-left"></i>  News</a></h3>
            <div class="block-options">
                <div class="block-options-item">
                    <a href="<?php echo e(route('newstype.create')); ?>" class="btn btn-success">Create </a>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <td class="text-center">
                        <div class="">
                                <a href="<?php echo e(route('newstype.edit',$item->id)); ?>" class="btn btn-primary">Edit </a>
                            <button type="button" class="btn btn-danger" data-toggle="tooltip" id="delbutton"
                                title="Delete" onclick="deleteNewstype(<?php echo e($item->id); ?>)">
                                Delete
                            </button>
                        </div>
                    </td>
        ...
        swal({
            ...
            if (isConfirm) {
                swal({
                    ...
                    window.location = "<?php echo e((route('newstypeDestroy'))); ?>/" + id;
                });
            }
        });
    }
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/news-type/index.blade.php ENDPATH**/ ?>