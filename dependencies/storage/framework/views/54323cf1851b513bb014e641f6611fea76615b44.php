        ...
        <div class="container">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="#" onclick="loadhtml();"  ><?php echo e($staticContent['Download_as_CSV']); ?></a>
                  <a class="dropdown-item" href="#" onclick="loadhtmlPDF();" ><?php echo e($staticContent['Download_AS_PDF']); ?></a>
                </div>
              </div>
            ...
            <form id="ContentComparePDF" action="<?php echo e(route('loadPdffilePDF')); ?>" method="POST">
                <?php echo e(csrf_field()); ?>
...
<script>
    ...
    function addHtmlUnitweight(index){
              html ='';
              html +='<tr>';
              html += ' <td class="col-1 col-xs-3"><?php echo e($staticContent['Unit_Weight']); ?></td>';
    ...
    function addHtmlDimen(index){
              html ='';
              html +='<tr>';
              html += ' <td class="col-1 col-xs-3"><?php echo e($staticContent['Dimensions']); ?></td>';
              html += '<td class="col-xs-3">'+getDimansion(pro1)+'</td>';
              html += ' <td class="col-xs-3">'+getDimansion(pro2) +'</td>';
              html += '<td class="col-xs-3">'+getDimansion(pro3)+'</td>'
              html +='</tr>';
        ...
        $.each(section, function(index,section){
         ...
         $.each(pd_field, function(index2,pd_val){
            ...
            if(pro1 != 0 || pro2 != 0){
             if(index2 == 0){
                html += ' <div class="comparison-heading">';
                html += ' <h6 class="text-center"><?php echo e($staticContent['Unit_Weight']); ?></h6>'
                html += '</div>';
                html += '<div class="comparison-detail">';
                html +=  '<div class="container comparison-detail-content">';
                html +=  ' <div class="comparison-detail-item mr-2">';
             ...
             if(index2 == 0){
                html += ' <div class="comparison-heading">';
                html += ' <h6 class="text-center"><?php echo e($staticContent['Dimensions']); ?></h6>'
                html += '</div>';
                html += '<div class="comparison-detail">';
                html +=  '<div class="container comparison-detail-content">';
                html +=  ' <div class="comparison-detail-item mr-2">';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/productcoparison.blade.php ENDPATH**/ ?>