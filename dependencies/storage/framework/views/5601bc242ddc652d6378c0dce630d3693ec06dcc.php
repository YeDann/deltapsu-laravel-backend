...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/backend-asset/addons/css/datatables.min.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('/backend-asset/addons/css/datatables-select.min.css')); ?>">
...
<body>
    ...
    <script>
        ...
        <script src="<?php echo e(asset('/admin-assets/addons/js/datatables.min.js')); ?>"></script>
        <script src="<?php echo e(asset('/admin-assets/addons/js/datatables-select.min.js')); ?>"></script>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/layouts/admin.blade.php ENDPATH**/ ?>