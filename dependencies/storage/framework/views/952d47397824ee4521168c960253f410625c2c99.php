...
<body class="full-padding" style="margin: 0;padding: 0;-webkit-text-size-adjust: 100%;">
    <!--<![endif]-->
         <div class="">
            <h4 style="margin:0 3px">Dear Customer,</h4>
             <p style="margin-bottom:5px;">
                Thank you for the interest in our power supplies, please see the configuration summary in the attached PDF file.<br>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/mail/sendpfdtomeFromFeedBack.blade.php ENDPATH**/ ?>