                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8 col-xl-8">
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input type="text" class="js-datepicker form-control <?php echo e($errors->has('date_start') ? 'is-invalid' : ''); ?>"  data-week-start="1" data-autoclose="true"
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <input id="timeStart" class="form-control <?php echo e($errors->has('time_start') ? 'is-invalid' : ''); ?>" placeholder="00:00" name="time_start" />
                                </div>
                                <div class="col-md-4">
                                    <label for="">Time End</label>
                                    <input id="timeEnd" class="form-control <?php echo e($errors->has('time_end') ? 'is-invalid' : ''); ?>"  placeholder="00:00" name="time_end" />
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="<?php echo e(route('event.index')); ?>" class="btn btn-secondary col-md-2">
                                Cancel 
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/event/create.blade.php ENDPATH**/ ?>