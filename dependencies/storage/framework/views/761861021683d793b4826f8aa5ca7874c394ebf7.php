        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb-home" aria-current="page"><a href="<?php echo e(route('index','product-notice')); ?>">PRODUCT NOTICE</a></li>
        ...
        <div class="box-news-detail">
            ...
            <div class="content">
                <div class="img-content">
                    <img src="<?php echo e(asset('/frontend-asset/image/Group 866-1@2x.png')); ?>" alt="" class="img-fluid col-6">
                </div>
                <br>
                ...
                <div class="img-content row">
                    <div class="col-6">
                        <img src="<?php echo e(asset('/frontend-asset/image/federico-beccari-ahi73ZN5P0Y-unsplash@2x.png')); ?>" alt="" class="img-fluid">
                    </div>
                    <div class="col-6">
                        <img src="<?php echo e(asset('/frontend-asset/image/israel-palacio-ImcUkZ72oUs-unsplash@2x.png')); ?>" alt="" class="img-fluid">
                    </div> 
                </div>
                <br>
                <p>Ligula dapibus </p>
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Deltapsu_Production\dependencies\resources\views\front-end\product-notice-detail.blade.php ENDPATH**/ ?>