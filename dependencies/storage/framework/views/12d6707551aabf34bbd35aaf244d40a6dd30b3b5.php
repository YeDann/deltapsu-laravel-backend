                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file " style="width:100%;">
                                    <input type="file" class="custom-file-input" id="file_input<?php echo e($item->name); ?>" onchange="checkmaxsize(`file_inputen` ,'file_lableen')" name="fileGU[en]"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/product_doc/create_doc.blade.php ENDPATH**/ ?>