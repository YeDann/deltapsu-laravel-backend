...
<div class="content mb-5">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content mb-5">
            <form id="submitformbkuser" method="POST" action="<?php echo e(route('updateBackendUser')); ?>">
                <?php echo csrf_field(); ?>
                <!-- Basic Elements -->
                        ...
                        *The password must be at least 8 characters.
                        ...
                        <div class="form-group row">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-1" name="role" value="All"  <?php echo e($user->lang == 'All' ?'checked':''); ?> >
                                    <label class="custom-control-label" for="status-1">admin</label>
                                </div>
                                <?php $__currentLoopData = $language; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-<?php echo e($lang->name); ?>" name="role"  value="<?php echo e($lang->name); ?>" <?php echo e($user->lang == $lang->name ?'checked':''); ?> >
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/user/editUser.blade.php ENDPATH**/ ?>