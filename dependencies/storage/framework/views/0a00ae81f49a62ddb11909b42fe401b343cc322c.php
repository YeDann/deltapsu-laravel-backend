...
<div class="box-deltapsu mb-5">
    <div class="container">
        ...
        <div class="row padding-mobile column-pic-text">
            <img class="col-lg-5 col-md-12 img-my-mobeile" src="<?php echo e(asset('/frontend-asset/image/banner-deltapsu-power-supply-unit_201508101439183122623766@2x.png')); ?>" alt="">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/about-deltapsu.blade.php ENDPATH**/ ?>