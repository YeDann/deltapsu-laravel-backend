        ...
        <div class="container">
            <nav aria-label="breadcrumb" id="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a href="#"><?php echo e($staticContent['Events&Calendar']); ?></a></li>
                </ol>
            </nav>
        </div>
    </div>
...
<div class="box-events mb-5">
    <div class="container">
        <h2 class="text-title-delta visible-up-922"><?php echo e($staticContent['Events&Calendar']); ?></h2>
        <h3 class="text-title-delta invisible-up-922"><?php echo e($staticContent['Events&Calendar']); ?></h3>
        ...
        <div class="tab content1 mt-4">
            ...
            <h2 class="text-title-delta"><?php echo e($staticContent['Upcoming_Event']); ?></h2>
            <div class="row">
                <?php 
                    ...
                    ?>
                <?php $__currentLoopData = array_slice($events->toArray(), 0, 3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="news-content">
                            <div class="post-meta">
                                <span class="author text-uppercase">
                                        <i class="zmdi zmdi-calendar-alt"></i> <?php echo e($date['m'].' '.$date['d'].' - '.($date['m'] != $endDate['m'] ?$endDate['m']:"" ).' '.(isset($endDate['d'])?''.$endDate['d']:'').' '.$date['y']); ?>
...
<script>
    ...
    function setloadEventBy(date){
        ...
        html += '<a href="<?php echo e(route('updateEventDetail')); ?>/'+event['slug']+ '">';
        html += '<img class="mr-3 img-event-slide" src="<?php echo e(config('app.url')); ?>/uploads_delta/'+event['thumb']+'" alt="">';              
        html += '</a>';
        ...
        html += '</h3>';
        html += '</a>';
        html += '<a href="<?php echo e(route('updateEventDetail')); ?>/'+event['slug'] +'"class="read-more-slide"><?php echo e($staticContent['Read_More']); ?></a>';
        html +=  '</div>';
        html +=  ' </div>';

        html2 += '<div class="col-lg-4 col-sm-6 col-md-6 mb-3">';
        html2 += '<div class="card">';
        html2 += '<a href="<?php echo e(route('updateEventDetail')); ?>/'+event['slug']+ '">';    
        html2 += '<div class="post-image">';
        html2 += '<img src="<?php echo e(config('app.url')); ?>/uploads_delta/'+event['thumb']+'" alt=""';
        ...
        html2 += '</p> ' ;              
        html2 += '</div>';
        html2 += ' <a href="<?php echo e(route('updateEventDetail')); ?>/'+event['slug'] +'"class="read-more"><?php echo e($staticContent['Read_More']); ?></a>';
        html2 += '</div>';
        html2 += '</div>';
         }
        });
      ...
      if(fildata.length == 0){
        html += '<div class="text-center"><?php echo e($staticContent['No_Event']); ?></div>';
        html2 += '<div class="text-center  m-auto" ><?php echo e($staticContent['No_Event']); ?></div>';
      }
...
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/event.blade.php ENDPATH**/ ?>