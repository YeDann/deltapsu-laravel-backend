...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Edit FAQ Categories</h1>
...
<div class="content">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content">
            <form action="<?php echo e(route('update_faqcategories')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo e(csrf_field()); ?>

            <input type="hidden" name="faq_cate_id" value="<?php echo e($faq_categories[0]->cate_id); ?>">
                <!-- Basic Elements -->
                <div class="row push">
                    <div class="col-lg-12">
                        <div class="block block-rounded block-bordered">
                            ...
                            <div class="block-content tab-content">
                                ...
                                <?php 
                                $current = null;
                                foreach($faq_categories as $item2) { 
                        ...
                        <div class="form-group">
                            ...
                            <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-1" name="status" value="1" <?php echo e($faq_categories[0]->status == 1 ?"checked":""); ?> >
                                    <label class="custom-control-label" for="status-1">Show</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline custom-control-primary">
                                    <input type="radio" class="custom-control-input" id="status-2" name="status" value="0" <?php echo e($faq_categories[0]->status == 0 ?"checked":""); ?>>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/faq/faq_cate_edit.blade.php ENDPATH**/ ?>