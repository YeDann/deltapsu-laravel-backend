                    ...
                    <input type="hidden" name="pro_id"  value="<?php echo e($products[0]->pro_id); ?>">
                        ...
                        <div class="block block-rounded block-bordered">
                            <ul class="nav nav-tabs nav-tabs-alt" data-toggle="tabs" role="tablist">
                                ...
                                <li class="nav-item">
                                        <a class="nav-link "  href="#btabs-alt-static-<?php echo e($alang->name); ?>"
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/product/edit.blade.php ENDPATH**/ ?>