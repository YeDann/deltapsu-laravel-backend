                                ...
                                <div class="form-group w-50">
                                    ...
                                    <a target="_blank" href="<?php echo e(config('app.url')); ?>/uploads_delta/<?php echo e(isset($current->file) ? $current->file :''); ?>"><?php echo e(isset($current->file) ? $current->file :''); ?></a>
                                       ...
                                       <?php if(isset($current->file)): ?>
                                                    <a href="<?php echo e(route('removeFileNewsDoc',[$item->name,$contents[0]->id])); ?>" target="_blank" class="btn btn btn-danger"><i class="fa fa-trash"></i> </a>
                                                        <?php endif; ?>
                                </div>
                                <div class="form-group w-50">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/news/edit.blade.php ENDPATH**/ ?>