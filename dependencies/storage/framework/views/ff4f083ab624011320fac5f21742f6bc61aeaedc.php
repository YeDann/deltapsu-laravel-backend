...
<div class="content mb-5">
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">Create Technical Article</h3>
        </div>
        <div class="block-content mb-5">
            <form action="<?php echo e(route('technical.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-8 col-xl-8">
                        ...
                        <div class="form-group w-50">
                            ...
                            <select name="type" class="form-control" id="">
                                <?php $__currentLoopData = $techType; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="<?php echo e(route('technical.index')); ?>" class="btn btn-secondary col-md-2">
                                Cancel 
                            </a>
                        </div>
                    </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/technical/create.blade.php ENDPATH**/ ?>