			...
			<nav aria-label="breadcrumb" id="breadcrumb">
				<ol class="breadcrumb">
					<li class="breadcrumb-item text-breadcrumb-home"><a
							href="<?php echo e(route('index','home')); ?>"><?php echo e($staticContent['Home']); ?></a></li>
					<li class="breadcrumb-item active text-breadcrumb-home dropdown" aria-current="page"><a href="#"
							data-toggle="dropdown" id="tools-dropdown"> <?php echo e($staticContent['Tools']); ?></a>
					...
					<li class="breadcrumb-item active text-breadcrumb" aria-current="page"><a
							href="#"><?php echo e($staticContent['configurable_power_selector']); ?></a></li>
				</ol>
			</nav>
		</div>
	</div>
				...
				<div class="row justify-content-center">
					...
					<div class="col-lg-4 col-md-12">
						<div class="content">
							...
							<p class="m-0"><span class="text-sixteen-delta c_delta"><b><?php echo e($staticContent['Unit_Weight']); ?></b></span>
							</p>
								...
								<div class="row mt-3 pt-2 add-space-mobile border-t-2px">
									<div class="col-4 column-total">
										<label for="output_total">
											<h5><?php echo e($staticContent['Total_No_of_Output']); ?></h5>
										</label>
									...
									<div class="col-4 offset-4 column-total">
										<label for="power">
											<h5><?php echo e($staticContent['Total_Output_Power']); ?></h5>
										</label>
										...
										<label for="">
											<h5><?php echo e($staticContent['Option']); ?>
												...
												<span  class="wrp-icons">
													<img id="option_ti"  class="align-baseline" src="<?php echo e(asset('frontend-asset/image/tooltip.svg')); ?>"
														data-toggle="tooltip" data-placement="top"
														title="<?php echo e($staticContent['Inlet_Type_description']); ?>">
												</span></h5>
										</label>
									...
									<div class="col-lg-6 col-md-12 mt-3">
										<label for="">
											<h5><?php echo e($staticContent['Communication']); ?>
												...
												<span class="wrp-icons">
													<img class="align-baseline" src="<?php echo e(asset('frontend-asset/image/tooltip.svg')); ?>"
														data-toggle="tooltip" data-placement="top"
														title="<?php echo e($staticContent['Communication_description']); ?>">
												</span></h5>
										</label>
										...
										<label for="">
											<h5><?php echo e($staticContent['Control_Code']); ?>
												...
												<span class="wrp-icons">
													<img class="align-baseline" src="<?php echo e(asset('frontend-asset/image/tooltip.svg')); ?>"
														data-toggle="tooltip" data-placement="top"
														title="<?php echo e($staticContent['Control_Code_description']); ?>">
												</span></h5>
										</label>
										<select class="form-control" id="logic" onchange="getToSummary()">
											<option selected="selected" value="0"><?php echo e($staticContent['Nomal_Logic_&_Normal_Fan_Direction']); ?>
			...
			<section>
				<div class="heading-for-mobile text-center invisible-up-922">
					...
					<h4 class="text-color-delta"><?php echo e($staticContent['Select_Parallel_Connection(s)']); ?><span class="wrp-icons">
							<img class="img-tooltip" src="<?php echo e(asset('frontend-asset/image/tooltip.svg')); ?>" data-toggle="tooltip"
								data-placement="top"
				...
				<div class="row justify-content-center add-space-mobile p-0">
					<div class="col-lg-8 col-md-12">
						<h5 class="text-center visible-up-922"><?php echo e($staticContent['Select_Parallel_Connection(s)']); ?>
							...
							<span class="wrp-icons">
								<img src="<?php echo e(asset('frontend-asset/image/tooltip.svg')); ?>" data-toggle="tooltip" data-placement="top"
									title="Select Logic for remote on/off function. Normal logic is power supply default on, reserved logic is default off.">
							</span>
						</h5>
						...
						<div class="summary-subbody d-flex flex-wrap justify-content-start">
							...
							<div class="col-lg-9 col-md-12" id="text-summary">
								<div class="col-lg-4 col-md-12">
									...
									<p class="m-0"><span
											class="text-sixteen-delta c_delta"><b><?php echo e($staticContent['Unit_Weight']); ?></b></span></p>
									<p class="c_delta_weight text-detail-describe m-0"></p>
									<br>
									<p class="m-0"><span class="text-sixteen-delta c_delta"><b><?php echo e($staticContent['Dimensions']); ?> (L x W x
												H)</b></span></p>
...
<div class="modal fade bd-example-modal-xl" id="sentToPDF" tabindex="-1" role="dialog" aria-labelledby="sentToPDF"
	...
	<div class="modal-dialog modal-lg modal-dialog-centered" role="document">
		<div class="modal-content">
			...
			<form id="submitSupport" name="configform" action="<?php echo e(route('SubmitContact')); ?>"
						...
						<div class="col-lg-6 col-md-12 my-2">
							...
							<div class="">
								<select name="state" class="form-control" id="stateId">
									<option value="" data-color="red"><?php echo e($staticContent['Select']); ?> <?php echo e($staticContent['City_State']); ?>
...
<script>
	...
	$("#configurable").steps({
		...
		onStepChanged: function (event, currentIndex, priorIndex) {
			...
			if(currentIndex === 3){
				...
				$('a[href$="previous"]').html('<button class="btn-enquiry" id="SbtRequest1" onclick="linktosupport();"><?php echo e($staticContent['Enquiry']); ?></button>'); 
	...
	function loadData(){
		...
		$('#img-fistdata').html('<img class="img-model " src="<?php echo e(config('app.url')); ?>/media/model/'+model_alldata[index]['thumb_img']+'">');
		$('.img-summary-add').html('<img class="img-fluid" src="<?php echo e(config('app.url')); ?>/media/model/'+model_alldata[index]['thumb_img']+'" >');
	
		
		$('#certificate').html('<img class="" src="<?php echo e(config('app.url')); ?>/media/model/'+model_alldata[index]['certificate_img']+'">');
		...
		// }
		 ...
		 if(model_alldata[index]['max_power'] == 3000){
				...
				$("#option_ti").attr('data-original-title', '<?php echo e($staticContent['Inlet_Type_description_MEG-3K0A9']); ?>');
		  ...
		  $('#terminal').empty();
				...
				$("#logic").append(new Option("Nomal Logic & Normal Fan Direction", "0"));
				$("#logic").append(new Option("Reversed Logic & Normal Fan Direction", "1"));
				$("#option_ti").attr('data-original-title', '<?php echo e($staticContent['Inlet_Type_description']); ?>');
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.front-end', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/front-end/configurableproduct.blade.php ENDPATH**/ ?>