    ...
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            ...
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"> <a href="<?php echo e(route('partner.index')); ?>" >Partner</a></li>
...
<div class="content mb-5">
    <div class="block block-rounded block-bordered">
        ...
        <div class="block-content mb-5">
            <form id="submitformbkuser" method="POST" action="<?php echo e(route('partner.store')); ?>">
                <?php echo csrf_field(); ?>
                <!-- Basic Elements -->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Deltapsu_Production/dependencies/resources/views/user/createpartner.blade.php ENDPATH**/ ?>